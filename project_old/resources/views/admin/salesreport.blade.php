                        ...
                        <div class="panel-body">
                            ...
                            <div class="card-body padding-bottom-0">
                                <form method="post" id="report_list" >
                                    ...
                                    <!--        <select type="text" class="form-control" id="countries" name="country" onchange="selectCountry()" required>-->
                                    <!--            <option value="all">All</option>-->
                                    ...
                                    <!--        <select type="text" id="allstates" class="form-control" name="state" required>-->
                                    <!--            <option value="all">All</option>-->
                                    <!--        </select>-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                    <div class="form-group col-sm-12">
                                        ...
                                        {{-- <input type="button" class="btn btn-warning excel" value="Excel" onclick="exportExcel()"> --}}
                                    </div>
                                </form>
                            </div>
...
<script type="text/javascript" src="{{ URL::asset('assets/js/admin/serversite.js')}}"></script>
