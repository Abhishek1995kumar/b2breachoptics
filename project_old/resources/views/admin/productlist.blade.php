                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            <ul class="nav nav-tabs tabs-left">
                                <li class="active"><a href="#product_list" data-toggle="tab" aria-expanded="true">Admin Product List</a>
                                 <li class=""><a href="#vendor_product" onclick="vendorProduct(event)" data-toggle="tab" aria-expanded="false">Vendor Product List</a>
                                <li class=""><a href="#vendor_pending" onclick="getVendorPendingProduct()" data-toggle="tab" aria-expanded="true">Vendor Pending Product List</a>
                        ...
                        <div class="col-xs-12">
                            <div class="tab-content">
                                    ...
                                    <div class="row" style="margin-bottom: 10px">
                                        ...
                                        <div class="col-md-3">
                                            <div class="premiumtype">
                                                <select class="form-control" id="premiumtype">
                                                    <option value="" selected disabled>Select Premium Type</option>
                                        ...
                                        <div class="col-md-5 text-right" id="exportButtonDiv" style="display: none">
                                            <a id="exportButton" onclick="exportExcel()" href="javascript:;"
                                                class="btn btn-primary btn-excel">Export Excel
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane" id="vendor_product">
                                    <div class="pull-right">
                                        <!--<a href="{{ url('admin/products/vendoradd') }}" style="background-color:#10e9b6" class="btn btn-primary btn-add"><i class="fa fa-plus"></i> Add Vendor Product</a>-->
                                    </div>
                                    ...
                                    <div class="row" style="margin-bottom: 10px">
                                        ...
                                        <div class="col-md-3">
                                            <select class="form-control" id="vendor_name">
                                                ...
                                                @foreach ($vendors as $vendor)
                                                    <option value="{!! $vendor->vendor_name !!}">{!! $vendor->vendor_name !!}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-3 text-right" id="vendor_export_ButtonDiv">
                                            <a id="Vendor_export_Button" href="javascript:;"
                                                class="btn btn-primary btn-excel">Export Excel
                                            </a>
                                        </div>
                                    </div>
