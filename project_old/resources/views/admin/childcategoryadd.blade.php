            ...
            <div class="row" id="main">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        @endif
                        <div id="response"></div>
                        <form method="POST" action="{!! action('ChildCategoryController@store') !!}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <div class="item form-group" id="fimg" style="display: none;">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Add Featured Image<span class="required">*</span>
                                    <p class="small-label">Must Be a Square Sized Image(1873x400)</p>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
