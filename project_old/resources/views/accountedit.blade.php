                                ...
                                <form action="{{ action('UserProfileController@update',['id' => $user->id]) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">    
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input class="form-control" type="number" name="phone" value="{{$user->phone}}" placeholder="e.g. 91+**********" required>
                                        </div>
                                        <div class="col-md-4 form-group">
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input class="form-control" type="email" name="email" value="{{$user->email}}" style="background-color: #fffcfc;" id="dash_email" placeholder="e.g. smith@gmail.com"  required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 form-group">
