...
<!--</form>-->
            ...
            <div class="header-top-entry increase-icon-responsive login">
                 ...
                 <!-- <div class="dropdown" style="padding-left: 20px;">
                    <div class="dropdown-toggle" data-toggle="dropdown">
                     ...
                     <a href="{{url('/language')}}" class="title"><i class="fa fa-language"></i>{{' '}}<span class="caret"></a>
                    <ul class="dropdown-menu translation-links dropdown-scrollbar" style="position : absolute;overflow:auto;">
                    <li><a href="javascript:void (0)" class="english" data-lang="English">English - EN</a></li>
                    <li><a href="javascript:void(0)" class="hindi" data-lang="Hindi">हिंदी - HI</a></li>
                    <li><a href="javascript:void(0)" class="marathi" data-lang="Marathi">मराठी - MA</a></li>
                    <li><a href="javascript:void(0)" class="tamil" data-lang="Tamil">தமிழ் - TA</a></li>
                    <li><a href="javascript:void(0)" class="telugu" data-lang="Telugu">తెలుగు - TE</a></li>
                    <li><a href="javascript:void(0)" class="kannada" data-lang="Kannada">ಕನ್ನಡ - KN</a></li>
                    <li><a href="javascript:void(0)" class="malayalam" data-lang="Malayalam">മലയാളം - ML</a></li>
                    <li><a href="javascript:void(0)" class="gujarati" data-lang="Gujarati">ગુજરાતી - GU</a></li>
                    <li><a href="javascript:void(0)" class="español" data-lang="Spanish">Español - ES </a></li>
                    <li><a href="javascript:void(0)" class="简体中文" data-lang="Chinese">简体中文 - ZH </a></li>
                    <li><a href="javascript:void(0)" class="deutsch" data-lang="Dutch">Deutsch - DE</a></li>
                    <li><a href="javascript:void(0)" class="português" data-lang="Portuguese">Português-PT</a></li>
                    <li><a href="javascript:void(0)" class="한국어" data-lang="Korean">한국어 - KO</a></li>
                    <li><a href="javascript:void(0)" class="اللغة العربية " data-lang="Arabic">اللغة العربية - AR </a></li>
                    </ul> 
                   </div>
                -->                 
        ...
        <div class="header-top-entry increase-icon-responsive login">
            ...
            @else
                <a href="{{route('vendor.dashboard')}}" class="title"><i class="fa fa-group"></i><span class="open-profile-popup">Hello , {{Auth::guard('vendor')->user()->name}}</span></a>
            @endif
        </div>
...
<!-- new added topbar -->
    <div id="top-bar-shubhnew"  >
            ...
            <div class="header-top-entry ">
                <a href="http://vamayekar.in/" class="title underline-on-hover" target="_blank" style="color: red;" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='red'" ><i class="fa fa-globe"></i> <span><b>MyWebSite</b></span></a>
            </div>
...
<div id="navcontainer">
 ...
 -->
                                 <div class="dropdown">
                                        <a href="{{url('/language')}}" class=" btn btn-primary title"><i class="fa fa-language"></i>{{' '}}Choose Language<span class="caret"></a>
