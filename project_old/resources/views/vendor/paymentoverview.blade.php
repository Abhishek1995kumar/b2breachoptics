                        ...
                        <table class="table" id="table">
                            ...
                            @foreach($CODlist as $row)
                                <tr>
                                    ...
                                    <td class="text-center"><a href="{{url('vendor/orderpayment/view/')}}/{{$row->id}}"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
                        ...
                        <thead>
                            ...
                            @foreach($CancelCODOrderlist as $row)
                                <tr>
                                    ...
                                    <td class="text-center">-₹ {{$row->cost}}</td>
                                    <td class="text-center"><a href="{{url('vendor/cancelpayment/view')}}/{{$row->id}}"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                                </tr>
                            @endforeach
                        ...
                        <thead>
                            ...
                            @foreach($ReturnCODOrderlist as $row)
                                <tr>
                                    ...
                                    <td class="text-center">-₹ {{$row->cost}}</td>
                                    <td class="text-center"><a href="{{url('vendor/returnpayment/view')}}/{{$row->id}}"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                                </tr>
                            @endforeach
                        ...
                        <thead>
                            ...
                            @foreach($completedCODOrderlist as $row)
                                <tr>
                                    ...
                                    <td class="text-center"><a href="{{url('vendor/todaypayment/view')}}/{{$row->id}}"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                                </tr>
                            @endforeach
