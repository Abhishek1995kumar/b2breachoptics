                    ...
                    <div class="panel-body">
                        ...
                        <!--<form method="POST" action="{!! action('VendorProductsController@update',['id' => $product->id]) !!}" class="form-horizontal form-label-left" enctype="multipart/form-data">-->
                            ...
                            <div class="item form-group" id="titledescriptionnew">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="titledescription" class="form-control col-md-7 col-xs-12" name="titledescription" value="{{$product->titledescription}}" placeholder="Product Description" required="required" type="text">
                                </div>
                            </div>
                            <div class="error">
