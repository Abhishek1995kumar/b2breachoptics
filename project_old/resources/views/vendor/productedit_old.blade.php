                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{!! action('VendorProductsController@update',['id' => $product->id]) !!}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="item form-group" id="powernew">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="power" value="{{$product->power}}" class="form-control col-md-7 col-xs-12" name="power" placeholder="Enter Power" type="text">
                                </div>
                            </div>
                            ...
                            <div class="item form-group" id="packagingnew">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control" name="packaging" id="packaging" >
                                        ...
                                        <option value="10 Lens Per Box">10 Lens Per Box</option>
                                        <option value="12 Lens Per box">12 Lens Per box</option>
                                        <option value="30 Lens Per Box">30 Lens Per Box</option>
                                        <option value="60 Lens Per Box">60 Lens Per Box</option>
                                    </select>
                                </div>
                            </div>
