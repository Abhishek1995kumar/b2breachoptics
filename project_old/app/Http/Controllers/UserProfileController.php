...
class UserProfileController extends Controller
{
    ...
    public function userorderdetails($id)  {
        ...
        $orders = DB::table('ordered_products as o')
                    ->select('o.*', 'ap.status as API_stataus', 'ap.status_code', 'ap.pickup_scheduled_date', 'ap.rtn_shipment_id', 'oo.cost as unite_price', 'oo.pay_amount', 'oo.order_number', 'po.color as p_color', 'po.lenscolor', 'po.producttat')
                    ->leftjoin('api_temp_resp as ap', 'o.orderid', '=', 'ap.order_id')
                    ->leftjoin('orders as oo', 'o.orderid', '=', 'oo.id')
        ...
        return view('orderdetails',compact('user','order','allorder', 'extraorder'));
    }
   ...
   public function deleteuser()  {
    ...
    public function get_active_subuserordeer_data($count, $search_term = '', $other_configs, $condition = false)
    {
        ...
        $data = DB::table('ordered_products as op')
                    ...
                    ->leftjoin('orders as o', 'op.orderid', 'o.id')
                    ->leftjoin('products',  'products.id','op.productid')
                    ->where('customer_id_new', Auth::user()->user_id)
                    ->orderBy('op.id','desc');
