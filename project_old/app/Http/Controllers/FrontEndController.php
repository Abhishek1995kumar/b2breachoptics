...
class FrontEndController extends Controller
{
    ...
    public function productdetails($id,$title) {
        ...
        return view('product', compact('productdata','product_baner','gallery','reviews','relateds','features','selected','tranding','category', 'user_profiles','product_gallery', 'averagerate', 'reviews1', 'reviews2', 'reviews3', 'reviews4', 'reviews5', 'prog1', 'prog2', 'prog3', 'prog4', 'prog5', 'allyear', 'allmonth', 'alldays', 'left_pd'));
    }
    ...
    public function getImageData(Request $request) {
        ...
        $mainImg = DB::table('products')->select('feature_image', 'id' , 'color', 'framecolor', 'price', 'costprice', 'lenscolor', 'category', 'stock', 'productsku', 'previous_price', 'colorcode')->where('id', $mid)->get();
    ...
    public function catproductnew($id) {
        ...
        if(isset($_GET) && !empty($_GET)){
            ...
            return view('categoryproduct', compact('cat', 'products', 'framecolor', 'frame_color','frame_material','frame_shape','lensmaterial','left_pd','category','sort','mins','user_profiles','maxs','maxvalue','colors','shapes','makes','gender','frametype','framematerial','lenscolor','size','brandname','lenstype','disposability','packaging','lensmaterialtype','lenstechnology','lensindex','visioneffect', 'netquntity', 'premiumtype', 'coating', 'brands', 'netQuentities', 'lenscolors', 'lens_coating', 'disposabilities'));
        }
    ...
    public function loadcatproduct($slug,$page) {
        ...
        // print_r($lenstype);
        // print_r("\n");
        // print_r($disposability);
        // print_r("\n");
        // print_r($packaging);
        // print_r("\n");
        // print_r($lensmaterialtype);
        // print_r("\n");
        // print_r($lenstechnology);
        // print_r("\n");
        // print_r($lensindex);
        // print_r("\n");
        // print_r($visioneffect);
        // print_r("\n");
        // print_r($lensestype);
        // print_r("\n");
        // print_r($radd);
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 single_product">
                            <div class="single-product-carousel-item">
                                <div class="image_latest_product_shubh">
                                    ...
                                    if($gallery){
                                        $res .= '<a class="img-top" href="' . url('/product') . '/' . $product->id . '/' . str_replace('/', '-', strtolower($product->title)) . '"> <img src="' . url('/assets/images/gallery') . '/' . $gallery[0]['image'] . '" src1="assets/images/subscription-form/subscibe_image.jpg" alt="Product Image" /> </a>';
                                    }
                                    else
                                    {
                                       $res .= '<a class="img-top" href="' . url('/product') . '/' . $product->id . '/' . str_replace('/', '-', strtolower($product->title)) . '"> <img src="" src1="assets/images/subscription-form/subscibe_image.jpg" alt="Product Image" /> </a>';
                                    }
                        $res .= '</div>
    ...
    public function cashondelivery(Request $request) {
        ...
        foreach ($pdata as $data => $product){
            ...
            if($categoryid[$data] == "72" || $categoryid[$data] == "58")  {
                ...
                $pres['parameter'] = $cart[0]->parameter;
    ...
    public function showprescription($id)  {
        ...
        if(isset($cart)){
            if($cart->parameter != ''){
                $data .= '<a data-toggle="modal" data-target="#viewparameter_'.$cart->id.'" >Parameter</a><br><br>';
            }
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body" style="text-align:center;">
                                    <table class"table table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th  style="border: 1px solid lightgrey"><center>' . ( $cart->a_size != "" ? $cart->a_size : "NULL" ) .'</center></th>
                                                <td  style="border: 1px solid lightgrey"><center>' . ( $cart->b_size != "" ? $cart->b_size : "NULL" ) . '</center></td>
                                                <td  style="border: 1px solid lightgrey"><center>' . ( $cart->dbl != "" ? $cart->dbl : "NULL" ) . '</center></td>
                                                <td  style="border: 1px solid lightgrey"><center>' . ( $cart->r_dia != "" ? $cart->r_dia : "NULL" ) . '</center></td>
                                                <td  style="border: 1px solid lightgrey"><center>' . ( $cart->l_dia != "" ? $cart->l_dia : "NULL" ) . '</center></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <br>
                                    <table class"table table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th  style="border: 1px solid lightgrey"><center>' . ($cart->r_fitting != "" ? $cart->r_fitting : "NULL") .'</center></th>
                                                <td  style="border: 1px solid lightgrey"><center>' . ($cart->l_fitting != "" ? $cart->l_fitting : "NULL") . '</center></td>
                                                <td  style="border: 1px solid lightgrey"><center>' . ($cart->bvd != "" ? $cart->bvd : "NULL") . '</center></td>
                                                <td  style="border: 1px solid lightgrey"><center>' . ($cart->r_ed != "" ? $cart->r_ed : "NULL") . '</center></td>
                                                <td  style="border: 1px solid lightgrey"><center>' . ($cart->l_ed != "" ? $cart->l_ed : "NULL") . '</center></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <br>
                                    <table class"table table-bordered" style="width:100%">
                                        <thead>
                                            <tr">
                                                <th style="width:2%; border: 1px solid lightgrey" scope="col"><center>MATERIALS</center></th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <th  style="border: 1px solid lightgrey"><center>' . ($cart->materials != "" ? $cart->materials : "NULL") .'</center></th>
                                                <td  style="border: 1px solid lightgrey"><center>' . ($cart->shape_code != "" ? $cart->shape_code : "NULL") . '</center></td>
                                                <td  style="border: 1px solid lightgrey"><center>' . ($cart->pantascopic != "" ? $cart->pantascopic : "NULL") . '</center></td>
                                                <td  style="border: 1px solid lightgrey"><center>' . ($cart->temple_size != "" ? $cart->temple_size : "NULL") . '</center></td>
                                                <td  style="border: 1px solid lightgrey"><center>' . ($cart->network_distance != "" ? $cart->network_distance : "NULL") . '</center></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <br>
                                    <table class"table table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th  style="border: 1px solid lightgrey"><center>' . ($cart->frame_fit != "" ? $cart->frame_fit : "NULL") .'</center></th>
                                                <td  style="border: 1px solid lightgrey"><center>' . ($cart->bow_angle != "" ? $cart->bow_angle : "NULL") . '</center></td>
                                                <td  style="border: 1px solid lightgrey"><center>' . ($cart->frame_type != "" ? $cart->frame_type : "NULL") . '</center></td>
                                                <td  style="border: 1px solid lightgrey"><center>' . ($cart->base_curve != "" ? $cart->base_curve : "NULL") . '</center></td>
