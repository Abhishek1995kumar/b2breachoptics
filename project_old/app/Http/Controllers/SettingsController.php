...
class SettingsController extends Controller
{
    ...
    {
        if(count(array_intersect(['V', 'U', 'N', 'D'], session()->get('role')['role_actions']['logo'])) == 0 && 
            count(array_intersect(['V', 'U', 'N', 'D'], session()->get('role')['role_actions']['favicon'])) == 0 &&
            count(array_intersect(['V', 'U', 'N', 'D'], session()->get('role')['role_actions']['wcgeneral'])) == 0 &&
            count(array_intersect(['V', 'U', 'N', 'D'], session()->get('role')['role_actions']['psgeneral'])) == 0 &&
            count(array_intersect(['V', 'U', 'N', 'D'], session()->get('role')['role_actions']['plgeneral'])) == 0 &&
            count(array_intersect(['V', 'U', 'N', 'D'], session()->get('role')['role_actions']['sigeneral'])) == 0 &&
            count(array_intersect(['V', 'U', 'N', 'D'], session()->get('role')['role_actions']['augeneral'])) == 0 &&
            count(array_intersect(['V', 'U', 'N', 'D'], session()->get('role')['role_actions']['offageneral'])) == 0 &&
            count(array_intersect(['V', 'U', 'N', 'D'], session()->get('role')['role_actions']['footer'])) == 0) {
    ...
    {
        if(count(array_intersect(['V', 'U', 'N', 'D'], session()->get('role')['role_actions']['plgeneral'])) == 0) {
            exit('<h3>Sorry! You have insufficient permissions to access this section</h3>');
        }
    ...
    {
        if(count(array_intersect(['D'], session()->get('role')['role_actions']['plgeneral'])) == 0) {
            exit('<h3>Sorry! You have insufficient permissions to access this section</h3>');
        }
