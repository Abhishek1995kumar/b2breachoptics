...
class CustomerController extends Controller
{
    ...
    public function accept($id)
    {
        ...
        // DB::statement(" update `user_profiles` set  `status` = '1' where `id` = $id");
        ...
        // die();
        return response()->json(['response' => 'Customer Accepted Successfully']);
    }
    ...
    public function reject($id)
    {
        ...
        return response()->json(['response' => 'Customer Inactive successfully.']);
    }
        ...
        if(isset($search_term) && $search_term !="") {
            ...
            $data = DB::table('user_profiles as up')
                ...
                ->where(function($query){
                    $query->where('up.status','=', '1');
                    $query->orwhere('up.status','=', '2');
                })
            ...
            // $data = DB::table('user_profiles as up')->where('status', '1')->orwhere('status', '2');
