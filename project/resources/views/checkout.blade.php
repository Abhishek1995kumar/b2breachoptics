                        ...
                        <div class="product-shipping-full-div">
                            <div class="row">
                                ...
                                <form  action="" method="post" id="payment_form">
                                    ...
                                    <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12">
                                        <div class="billing-details-area">
                                            <div class="col-sm-12" style="display: flex; gap:52%; bottom: 20px;">
                                            ...
                                            <div class="col-lg-6 col-md-3 col-sm-12 col-xs-12 padding-right-0">
                                                <div class="form-group">
                                                <select     style="font-weight: bold;" name="method" onChange="meThods(this)" class="form-control" style=" font-weight : 500;" required>
                                ...
                                <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-lg-6 col-md-3 col-sm-12 col-xs-12 padding-left-0">
                                        <div class="form-group">
                                            <label for="seller_notes">Seller Order ID<span></span></label>
                                            <input type="text" id="seller_notes" class="form-control" name="seller_order_id">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-3 col-sm-12 col-xs-12 padding-right-0">
                                        <div class="form-group">
                                            <label for="buyer_notes">Buyer Order ID<span></span></label>
                                            <input type="text" id="buyer_notes" class="form-control" name="buyer_order_id" >
                                        </div>
                                    </div>
                                    <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        function meThods(val) {
            ...
            if(val.value == "Razorpay"){
                ...
                $("#order_payment").find('div').append(`<input class="btn btn-md order-btn" id="" value="select payment mode">`);
            }
