        ...
        <div class="modal-content">
            ...
            <form action="" id="LensePrescription" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body" style="padding:10px; display: flex; justify-content: center; align-items: center;">
                    <div class="col-lg-12 lensesprescriptionmodal" style="">
                        ...
                        <input type="checkbox" id="checkparameter" name="parameter" value="1" class="parameter_checkbox" onclick="addParamete(event)"> ADD PARAMETER
                        <br>
                        <br>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="2" class="text-center">
                                        <input class="form-control" type="text" id="a_size" name="a_size" class="" style="width: 138px">
                                    </td>
                                    <td colspan="2" class="text-center" style="width: 138px">
                                        <input class="form-control" type="text" id="b_size" name="b_size" class="" style="width: 138px">
                                    </td>
                                    <td colspan="2" class="text-center" style="width: 138px">
                                        <input class="form-control" type="text" id="dbl" name="dbl" class="" style="width: 138px">
                                    </td>
                                    <td colspan="2" class="text-center" style="width: 138px">
                                        <input class="form-control" type="text" id="r_dia" name="r_dia" class="" style="width: 138px">
                                    </td> 
                                    <td colspan="2" class="text-center" style="width: 138px">
                                        <input class="form-control" type="text" id="l_dia" name="l_dia" class="" style="width: 138px">
                                    </td> 
                                </tr>
                                <tr>
                                ...
                                <tr>
                                   <td colspan="2" class="text-center">
                                        <input class="form-control" type="text" id="r_fitting" name="r_fitting" class="" style="width: 138px">
                                    </td>
                                    <td colspan="2" class="text-center" style="width: 138px">
                                        <input class="form-control" type="text" id="l_fitting" name="l_fitting" class="" style="width: 138px">
                                    </td>
                                    <td colspan="2" class="text-center" style="width: 138px">
                                        <input class="form-control" type="text" id="bvd" name="bvd" class="" style="width: 138px">
                                    </td>
                                    <td colspan="2" class="text-center" style="width: 138px">
                                        <input class="form-control" type="text" id="r_ed" name="r_ed" class="" style="width: 138px">
                                    </td> 
                                    <td colspan="2" class="text-center" style="width: 138px">
                                        <input class="form-control" type="text" id="l_ed" name="l_ed" class="" style="width: 138px">
                                    </td> 
                                </tr>
                                <tr>
                                    <th colspan="2" class="text-center">Corridor</th>
                                ...
                                <tr>
                                    <td colspan="2" class="text-center" style="width: 138px">
                                        <input class="form-control" type="text" id="materials" name="materials" class="" style="width: 138px">
                                    </td> 
                                    <td colspan="2" class="text-center" style="width: 138px">
                                        <input class="form-control" type="text" id="shape_code" name="shape_code" class="" style="width: 138px">
                                    </td> 
                                    <td colspan="2" class="text-center" style="width: 138px">
                                        <input class="form-control" type="text" id="pantascopic" name="pantascopic" class="" style="width: 138px">
                                    </td>
                                    <td colspan="2" class="text-center" style="width: 138px">
                                        <input class="form-control" type="text" id="temple_size" name="temple_size" class="" style="width: 138px">
                                    </td> 
                                    <td colspan="2" class="text-center" style="width: 138px">
                                        <input class="form-control" type="text" id="network_distance" name="network_distance" class="" style="width: 138px">
                                    </td> 
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="2" class="text-center">
                                        <input class="form-control" type="text" id="frame_fit" name="frame_fit" class="" style="width: 138px">
                                    </td>
                                    <td colspan="2" class="text-center">
                                        <input class="form-control" type="text" id="bow_angle" name="bow_angle" class="" style="width: 138px">
                                    </td>
                                    <td colspan="4" class="text-center" style="width: 138px">
                                        <input class="form-control" type="text" id="frame_type" name="frame_type" class="" style="width: 264px">
                                    </td>
                                    <td colspan="2" class="text-center" style="width: 138px">
                                        <input class="form-control" type="text" id="base_curve" name="base_curve" class="" style="width: 138px">
                                    </td>
                ...
                <div class="modal-footer" style="display: flex; justify-content: space-between; align-items: baseline;">
                    <button type="button" class="btn btn-success" onclick="lensPrescription(event)" id="getPrescription" style="outline:none; width: 80px;">Save</button>
                </div>
            </form>
        </div>
    </div>
