                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{!! action('BlogController@update',['id' => $blog->id]) !!}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Current Featured Video<span class="required">*</span>

                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <video width= "width: 375px;" height="300px" controls="">
                                        <source src="{{url('/assets/images/blog')}}/{{$blog->featured_image}}" id="adminvideo2" type="video/mp4">
                                    </video>
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Change Video<span class="required">*</span>
