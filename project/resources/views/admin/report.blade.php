        ...
        <div class="dashboard-header-area col-lg-12 col-md-12 col-sm-12 col-xs-12" >
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                <div class="single-dashboard-product-head" >
                    ...
                    <div class="bottom-link">
                        <a class="detail-link clearfix btn-block" href="{{url('admin/report_list')}}">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                <div class="single-dashboard-product-head" >
                    ...
                    <div class="border-bottom"></div>
                    <div class="bottom-link">
                        <a class="detail-link clearfix btn-block" href="{{url('admin/sales_report_list')}}">
                            <span class="pull-left">Search</span>
                            <span class="pull-right"><i class="fa fa-chevron-circle-right"></i></span>
                        </a>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                <div class="single-dashboard-product-head" >
                    ...
                    <div class="border-bottom"></div>
                    <div class="bottom-link">
                        <a class="detail-link clearfix btn-block" href="{{url('admin/returnOrderList')}}">
                            <span class="pull-left">Search</span>
                            <span class="pull-right"><i class="fa fa-chevron-circle-right"></i></span>
                        </a>
                    </div>
