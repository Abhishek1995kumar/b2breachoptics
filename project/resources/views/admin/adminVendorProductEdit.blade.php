                        ...
                        <form id="productFormSubmit"  class="form-horizontal form-label-left" enctype="multipart/form-data">
                          ...
                          <div class="item form-group">
                            ...
                            <div class="item form-group" id="productdimensionAccessories">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="productdimensiondata" class="form-control col-md-7 col-xs-12" value="" name="productdim" placeholder="Product Dimension"  type="text">
                                </div>
                            </div>
                                                ...
                                                <td class="col-md-3">
                                                    <select class="form-control attr_pro_color" name="attr_pro_color[]">
                                                        @foreach($attrColor as $a)
                                                            <option value="{{$a->color}}" <?php if($a->color == $attr->attr_color){ echo 'selected';}?> >{{$a->color}}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
