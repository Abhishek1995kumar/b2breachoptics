                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-md-4">
                                ...
                                @if(isset($allcancelTax))
                                    ...
                                    <p>Payment Tye:- {{$allcanceldata->order_payment_method}}</p>
                                @else
                                @endif
                            </div>
                            <div class="col-md-2">
    ...
    <div class="container pb-5 mb-sm-4">
        ...
        <div class="row mb-3">
            <div class="col-sm-4 mb-2">
                <div class="bg-secondary p-4 text-dark text-center" style="padding-top: 12px;"><span class="font-weight-semibold mr-2">Status:</span><?php if($allcanceldata->status == 'cancelled' || $allcanceldata->status == 'declined') echo " Cancelled" ?></div>
            </div>
            <div class="col-sm-4 mb-2">
        ...
        <div class="steps">
            <div class="steps-header">
                @if($allcanceldata->status == 'declined')
                    <div class="progress">
                        @if($allcanceldata->status == 'pending')
                            <div class="progress-bar" role="progressbar" style="width: 20%; background-color:red;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                         @elseif($allcanceldata->status == 'processing' || $allcanceldata->order_accept_date)
                               <div class="progress-bar" role="progressbar" style="width: 40%; background-color: red;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                         @elseif($allcanceldata->status == 'picked' || $allcanceldata->pickup_date)
                            <div class="progress-bar" role="progressbar" style="width: 60%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                        @elseif($allcanceldata->status == 'intransit' || $allcanceldata->intransit_date)
