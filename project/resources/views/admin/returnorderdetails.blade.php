            ...
            <div class="row">
                ...
                <div class="go-title">
                    <div class="pull-right">
                        <a href="{!! url('admin/return/order/adminlist') !!}" class="btn btn-default btn-back"><i class="fa fa-arrow-left"></i> Back</a>
                    </div>
                </div>
                ...
                <div class="col-md-8">
                    <div class="card mb-3" style="max-width: 100%;">
                          <div class="row no-gutters">
                            ...
                            <div class="col-md-2">
                              <h5><b>Tracking Details</b></h5>
                              <p>ID:- {{$allcanceldata->status}}</p>
                              <p>Logistic:- Ship Rocket</p>
                            </div>
...
<!-- cancel order tracking  view -->
      ...
      @if($allcanceldata->return_status == 'accept')
        <div class="stepper-wrapper">
          ...
          <div class="stepper-item">
            <div class="step-counter"></div>
            <div class="step-name">{{$allcanceldata->created_at}}</div>
            <p>In Transit</p>
          </div>
          <div class="stepper-item">
            <div class="step-counter"></div>
      ...
      @elseif($allcanceldata->return_status == 'intransit')
        <div class="stepper-wrapper">
          <div class="stepper-item completed">
            <div class="step-counter"></div>
            <div class="step-name">{{$allcanceldata->created_at}}</div><br>
      ...
      @elseif($allcanceldata->return_status == 'completed')
        <div class="stepper-wrapper">
          <div class="stepper-item completed">
            <div class="step-counter"></div>
            <div class="step-name">{{$allcanceldata->created_at}}</div><br>
