                                        ...
                                        <div id="overview-tab-1" class="tab-pane active fade in">
                                            ...
                                            <h1 class="product-price">
                                                ...
                                                @endif
                                                  <span style="font-size: 25px; font-weight : bold">
                                                    {{$settings[0]->currency_sign}}</span><span id="price_span" style="font-size: 25px; font-weight : bold">{{\App\Product::Cost($productdata->id)}}</span>
                                            ...
                                            @if($productdata->category[0] != '')
                                                ...
                                                <div class="color_name">
                                                    <span style="font-size: 13px;"><b> Color : </b> Contact Lens <span id="color_span" >{{$productdata->lenscolor}}</span> </span>
                                                </div>
                                                @else
                                                <div class="color_name">
                                                    <span style="font-size: 13px;"><b> Color : </b>Frame <span id="color_span">{{$productdata->color}}</span> </span>
                                                </div>
                                                @endif
                                            @endif
                                            ...
                                            <div class="attrColor btn-group" style="gap:5px; position: relative; padding: 5px;">
                                                @if($productdata->category[0] != '')
                                                    @if($productdata->category[0] == 72)
                                                        ...
                                                        <img alt="color image" width="50" src="{{url('/assets/images/products')}}/{{$productdata->feature_image}}"/>
                                                    </button>
                                                    @else
                                                ...
                                                @if(isset($product_gallery))
                                                    @foreach($product_gallery as $attr)
                                                        @if($attr != '')
                                                        <button id="getData{{$attr->pid}}"  class="main-class" type="button" style="border : 1px solid #c1bcbc;  background: #fff;" onclick="changeImage('{{$attr->color}}', this)" data="{{$attr->pid}}">
                                            ...
                                            @if($productdata->category[0] != '')
                                                ...
                                                <div style="display: flex; padding-top: 5px;">
                                                    <div class="product-size text-center" id="product-size"><span style="width: 60px;" onclick="changeSize('{{$productdata->productdimension}}')" class="sizeClick" data="{{$productdata->productdimension}}">{{$productdata->productdimension}}</span>
                                                      </div>
                                                </div>
                                                 @endif
                                            @endif
                                           ...
                                           <!--  <h5>Color</h5><p class="product-size">{{$productdata->color}}</p>
                                              ...
                                              @elseif($productdata->category[0] == 72)
                                               ...
                                               <li>Model No. <span style="padding-left: 23%;">{{$productdata->modelno}}</span></li> 
                                                <li>Product Sku <span style="padding-left: 19%;">{{$productdata->productsku}}</span></li>
                                                 <li>Usages Duration <span style="padding-left: 10%;">{{$productdata->usagesduration}}</span></li> 
                                            ...
                                            <div>
                                                ...
                                                <form class="addtocart-form">
                                                    ...
                                                    <input type="hidden" id="main_price" name="main_price" value="{{$productdata->price}}">
                                                    ...
                                                    <input type="hidden" name="category" value="{{$productdata->category[0]}}">
                                                    <input type="hidden" name="title" value="{{$productdata->title}}">
                                                    <input type="hidden" name="product" value="{{$productdata->id}}">
                                                    @if($productdata->category[0] != '')
                                                        @if($productdata->category[0] != 72)
                                                    
                                                         <input type="hidden" name="maincolor" value="{{$productdata->color}}">
      ...
      <div class="col-md-5">
        ...
        <div class="col-md-5">
            <table width="100" class="table" border='0'>
                ...
                <table width="50" class="table" border='0' style="table-layout: fixed;">
                    <tbody>
                        <tr style="border:none;">
        ...
        <div class="col-md-5">
            ...
            <table width="100" class="table" border='0'>
                <tbody>
                  <tr style="border:none;">
                    <td style="width: 35%; border:none;">Manufracturer</td>
                    <td style="width: 5%; text-align: center;border:none;"> : </td>
                    <td style="width: 54%;border:none;">@if($productdata->manufracturer =='') NA @else  {{$productdata->manufracturer}}@endif</td>
                  </tr>
            <table width="100" class="table" border='0'>
            ...
            <!--    <tbody>-->
            <!--      <tr style="border:none;">-->
            <!--        <td style="width: 35%; border:none;">Lens Technology</td>-->
            <!--        <td style="width: 5%; text-align: center;border:none;"> : </td>-->
            <!--        <td style="width: 54%;border:none;">@if($productdata->lenstechnology =='') NA @else  {{$productdata->lenstechnology}}@endif</td>-->
            <!--      </tr>-->
            <table width="100" class="table" border='0'>
...
<script>
    ...
    // function changeColor(size, data) {
    //     jQuery('.attrColor').html('');
    //     var value = size;
    //     var id = $('.sizeClick').attr('data');
    //     url = "{{url('product/changeColor/')}}";
    //     $.ajax({
    //         type: 'POST',
    //         url: url,
    //         data: {
    ...
    //                             <button id="getData${data[i].id}" class="btn btn-primery" style="background-color: ${data[i].attr_color}; height: 26px; width: 10px; outline:none; border-radius: 20px;" data="${data[i].id}" onclick="changeImage(${data[i].id})"></button>
    //                         </div>`;
    //                 jQuery('.attrColor').append(html);
    //             }
    //         }
    //     });
    // }
    ...
    function changemainImage(data, ele) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#price_span').text(data.cost_price);

                $('#price').val(data.cost_price);
                $('#main_price').val(data.cost_price);
      ...
      $('.attrColor').find('button').removeClass('selected_css');
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#price_span').text(data.sizes[0].attr_price);
                ...
                if(data.sizes[0].attr_size != '') {
                    ...
                    for(let j=0; j<data.sizes.length; j++) {
                        html2 = `<span style="width: 60px;" onclick="changeSize('${data.sizes[j].attr_size}')" class="sizeClick" data="${data.sizes[j].product_id}">${data.sizes[j].attr_size}</span>`;
                    }
