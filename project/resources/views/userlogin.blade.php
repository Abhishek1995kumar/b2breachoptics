    ...
    <div class="wrapper">
        <div class="container1">
            ...
            <div style="border:none" class="contentBx">
                <div class="formBx">
                    <h2 class="form-title" style="border-bottom: solid 1px white;">Sign in</h2>
                    <form id="loginForm" method="post" enctype="multipart/form-data">
                        ...
                        <div class="inputBx">
                           <p>Don't have an account?<a href="{{route('user.reg')}}" style="border-bottom: solid 1px grey;">Sign Up</a></p>
                        </div>
                        <div class="inputBx">
                           <p><a href="{{route('user.forgotpass')}}" style="color: red; ">Forgot Password?</a></p>
                        </div>
                    </form>
