                    ...
                    <div class="col-lg-6 col-lg-offset-3 col-md-offset-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="newAccount-area">
                            ...
                            <form action="{{route('subuser.reg.submit')}}" method="post">
                                ...
                                <div class="form-group">
                                    <!--<label for="reg_Pnumber">Phone Number <span>*</span></label>-->
                                    <input class="form-control" type="text" placeholder="Address" name="address" value="{{old('address')}}" id="addr_ss" required>
                                </div>
                                <div class="form-group">
                                    <!--<label for="reg_Pnumber">Phone Number <span>*</span></label>-->
                                    <input class="form-control" type="text" placeholder="Zip" name="zip" value="{{old('zip')}}" id="zip" required>
                                </div>
                                
                                <div class="form-group">
                                     <select type="text" id="country-dropdown" class="form-control" name="country" >
                                ...
                                <div class="form-group">
                                    <select type="text" id="state-dropdown" class="form-control" name="state">
                                       <option class="bold-option">Select State</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <select type="text" id="city-dropdown" class="form-control" name="city">
                                   
                                        <option class="bold-option">Select City</option>
                                    </select>
                                </div>
                                 <div class="form-group">
