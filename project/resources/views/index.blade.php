...
@section('content')
    <style type="text/css">
        ...
        @media screen and (max-width: 768px) {
            ...
            .logo-carousel-wrapper .container-fluid .row .owl-carousel.owl-loaded {
                height: 100px;
            }
            ...
            #bottomCarouselSlider #myCarousel .carousel-inner {
                height: 300px;
            }
            
            #bottomCarouselSlider #myCarousel .carousel-inner .item a {
                height: 300px;
            }
        }
            ...
            <div id="myCarousel" class="carousel slide demo" data-ride="carousel">
                <div class="carousel-inner">
                    @foreach ($mainslider as $key => $banner)
                        <div class="item {{ $key == 0 ? 'active' : '' }}" style="overflow: hidden">
                            <a href="{{ $banner->link }}">
                                @php
                                    echo '<img style="border-radius: 10px; width: 100%;" src="' . asset('assets/images/sliders') . '/' . $banner->image . '">';
                                @endphp
                            </a>
                        </div>
                    @endforeach
                            ...
                            <div class="row">
                                <div class="flex-container">
                                    @foreach ($smallbox as $banner)
                                        <div class="flex-item {{$key == 0 ? 'active':''}}">
                                ...
                                <div class="single-product-carousel-item">
                                    <div class="container-fluid">
                                        <div class="image_latest_product_shubh">
                                            ...
                                            <a
                                                href="{{ url('/product') }}/{{ $product->id }}/{{ str_replace('/', '', strtolower($product->title)) }}" target="_blank">
                                                @php
                                                    echo '<img src="' . asset('assets/images/products') . '/' . $product->feature_image . '" class="responsive" target="_blank">';
                                                @endphp
                                            </a>
                                            <a class="img-top"
                                                href="{{ url('/product') }}/{{ $product->id }}/{{ str_replace('/', '', strtolower($product->title)) }}" target="_blank">
                                                @if($gallery)
                                                    @php
                                                        echo '<img src="' . asset('assets/images/gallery') . '/' . $gallery[0]['image'] . '" class="responsive" target="_blank">';
                                                    @endphp
                                                @endif
                                        </div>
                                    </div>
                            ...
                            <div class="single-product-carousel-item">
                                <div class="image_latest_product_shubh">
                                    ...
                                    <a class="img-top"
                                        ...
                                        @if(isset($gallery[0]))
                                            @php
                                                echo '<img src="' . asset('assets/images/gallery') . '/' . $gallery[0]['image'] . '" class="responsive" style="margin: 0px; margin-left: 0px;" target="_blank">';
                                            @endphp
                                        @endif
                                    </a>
                                </div>
                                ...
                                <div class="single-product-carousel-item">
                                    <div class="image_latest_product_shubh">
                                        <a href="{{ url('/product') }}/{{ $product->id }}/{{ str_replace('/', '', strtolower($product->title)) }}" target="_blank">
                                            @php
                                                echo '<img src="' . asset('assets/images/products') . '/' . $product->feature_image . '" class="responsive" style="margin: 0px; margin-left: 0px;" target="_blank">';
                                            @endphp
                                        </a>
                                    </div>
                                    <div class="product-carousel-text">
