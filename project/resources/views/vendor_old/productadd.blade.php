                    ...
                    <div class="panel-body">
                        ...
                        <!--<form method="POST" action="{!! action('VendorProductsController@store') !!}" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>-->
                            ...
                            <div class="item form-group" id="titledescriptionnew">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="titledescription">Product Name Description <span class="required" style="color:red;">*</span>
                                    <p class="small-label">(In Any Language)</p>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="titledescription" class="form-control col-md-7 col-xs-12" name="titledescription" value="{{old('titledescription')}}" placeholder="Product Description" required="required" type="text">
                                </div>
                            </div>
                            <div class="error">
                                @if ($errors->has('titledescription'))
                                    <span class="help-block">
                                         <strong style="color: red;">{{ $errors->first('titledescription') }}</strong>
                                    </span>
                                @endif
                            </div>
