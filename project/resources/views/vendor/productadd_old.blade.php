                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{!! action('VendorProductsController@store') !!}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="item form-group" id="powernew">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="powermin" value="{{old('powermin')}}" class="form-control col-md-7 col-xs-12" name="powermin" placeholder="Enter Sphere Power" type="text">
                                </div>
                            </div>
                            ...
                            <div class="item form-group" id="powernew">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="powermax" value="{{old('powermax')}}" class="form-control col-md-7 col-xs-12" name="powermax" placeholder="Enter Sphere Power" type="text">
                                </div>
                            </div>
                            ...
                            <div class="item form-group" id="coatingnew">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="coating" value="{{old('coating')}}" class="form-control col-md-7 col-xs-12" name="coating" placeholder="Enter Coating" type="text">
                                </div>
                            </div>
