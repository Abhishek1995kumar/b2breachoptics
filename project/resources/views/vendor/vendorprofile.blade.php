            ...
            <div class="row" id="main">
                ...
                <div class="panel panel-default">
                    ...
                    @if(isset($vendor))
                        ...
                        <div class="form-group row">
                            <label for="staticEmail" class="control-label col-md-3 col-sm-3 col-xs-12">Address Proof</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input onchange="showAddressProofImage(this)" name="addressproof" id="addressproof" value="{{ $vendor->addressproof }}" type="file" placeholder="Select Udyam Image"class="form-control"><i class="fa fa-eye showpwd"  data-toggle="modal" data-target="#myModal7"  style="margin-left: -30px; float: right; padding-right: 10px; margin-top: -25px"></i>
                            </div>
                        </div>
...
<div class="modal fade" id="myModal7" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document" style="margin-left: 2rem;">
        <div class="modal-content"  style="width:130rem; height:59rem" >
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title text-center" id="myModalLabel">Uploaded Adhar Proof Image</h4>
            </div>
            <div class="modal-body">
                <div class="text-center">
                    @if($vendor->addressproof !='')
                    <iframe src="{{url('/assets/images/vendor/addressproof')}}/{{ $vendor->addressproof }}" id="showaddressimage" width="1200px" height="500px" ></iframe>  
                    @else
                    <img src="{{url('/assets/images/vendor/addressproof')}}/{{ $vendor->addressproof }}" id="showaddressimage" width="1200px" height="500px" >  
                    @endif 
                </div>
            </div>
        </div>
...
@section('footer')
    ...
    function showAddressProofImage(input){
        if(input.files){
            let addressFile = new FileReader();
            addressFile.readAsDataURL(input.files[0]);
            addressFile.onload = function(e){
                $("#showaddressimage").attr('src', e.target.result);
            }
        }
    }
    </script>
