    ...
    <div class="container1">
        <div style="border:none" class="contentBx">
            <div class="formBx">
              ...
              <h2 class="text-center" style="border-bottom: solid 1px #3adfca;">Reset Password</h2>
              ...
              <p>Use The Input  Below To Get Started.</p>
                <form id="reset_pass" role="form" autocomplete="off" class="form" method="post">
                    <div class="inputBx" style="display: flex; align-items: center; padding-top: 12px;">
                        <span style="display: block; margin-right: 12px;"><i class="fa fa-envelope" style="padding-top: 8px; color:#19e5a5;"></i></span>
                        <span style="display: block;"> <input id="email" style="text-align: center;width: 243px; background-color: #880707;"  name="mobile" placeholder="Mobile No" class="form-control" disabled hidden value="<?php echo $email; ?>"  type="text"></span>
                    </div>
                    <div class="inputBx" style="display: flex; align-items: center;padding-top: 12px;">
...
$("#reset_pass").on('submit', function(e){
      ...
      var form_data = {'email':email,'first_pass':first_pass,'confirm_pass':confirm_pass };
        e.preventDefault();
        $.ajax({
            url: "{{url('user/test')}}",
            data:form_data,
