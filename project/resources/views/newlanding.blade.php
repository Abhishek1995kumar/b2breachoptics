...
<div id="example1">
    ...
    <div class="d-grid gap-2 d-md-block text-center">
      <a href="{{url('/home')}}" style="color: black; background-color:white;"  class="btn btn-outline-secondary"  onMouseOver="this.style.backgroundColor='#d8c3a5'" onMouseOut="this.style.backgroundColor='white'">Product Catalogue</a>
    </div>
