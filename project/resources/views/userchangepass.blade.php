                                ...
                                <form action="{{ action('UserProfileController@passchange',['id' => $user->id]) }}" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 form-group">
                                            ...
                                            <input class="form-control" type="password" name="cpass" id="dash_password" placeholder="e.g. Smith@123" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8 form-group">
                                            <label for="new_password">new password <span>*</span></label>
                                            <input class="form-control" type="password" name="newpass" id="new_password" placeholder="e.g. Smith@1234" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8 form-group">
                                            <label for="change_password">change password <span>*</span></label>
                                            <input class="form-control" type="password" name="renewpass" id="change_password" placeholder="e.g. Smith@1234" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8 form-group">
                                            <!--<a class="address-btn" type="submit" value="change password">Edit address</a>-->
                                            <input class="editpage-save-button" type="submit" value="change password">
                                        </div>
                                    </div>
                                </form>
                            </div>
