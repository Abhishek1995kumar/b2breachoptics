...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        $vendors = Vendors::select('id', 'shop_name')->orderBy('id', 'desc')->get();
    ...
    public function get_vendor_list_data($count, $search_term = '', $other_configs, $vendor_category = null, $vendor_name = null)  {
        ...
        if ($vendor_name) {
            $data->where('p.vendorid', $vendor_name);
        }
    ...
    public function vendorProductExcel(Request $request){
        ...
        $data = Product::where('owner', 'vendor')->where('approved', 'yes')->whereIn('status', [0, 1]);
        if($vendor_category){
            $data->where('category', $vendor_category);
        }
        if($vendor_name){
            $data->where('vendorid', $vendor_name);
        }
