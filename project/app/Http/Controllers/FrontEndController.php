...
class FrontEndController extends Controller
{
    ...
    public function productdetails($id,$title)
    {
        ...
        return view('product', compact('cartsmain', 'pid', 'productdata','product_baner','gallery','reviews','relateds','features','selected','tranding','category', 'product_gallery', 'averagerate', 'reviews1', 'reviews2', 'reviews3', 'reviews4', 'reviews5', 'prog1', 'prog2', 'prog3', 'prog4', 'prog5', 'allyear', 'allmonth', 'alldays', 'left_pd', 'is_reviews_avaible'));
    }
    ...
    public function catproductnew($id) {
        ...
        // return view('categoryproduct', compact('products','lensmaterial','left_pd','category','sort','mins','maxs','maxvalue','colors','shapes','makes','gender','frametype','framematerial','lenscolor','size','brandname','lenstype','disposability','packaging','lensmaterialtype','lenstechnology','lensindex','visioneffect'));
    }
