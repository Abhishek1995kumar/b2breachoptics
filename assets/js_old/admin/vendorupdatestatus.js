...
{
    var url = baseUrl + "/admin/vendors/deactive/"+id;
    if(id){
        Swal.fire({
          title: 'Message!',
...
function vendorAccept(id) {
    var url = baseUrl + "/admin/vendors/accept/doc/"+id;
    if(id){
        Swal.fire({
          title: 'Message!',
...
function vendorAcceptData(id, url) {
    let url2 = baseUrl + "/admin/vendors";
    $.ajax({
        type: "POST",
        url: url,
        headers: {
...
function vendorReject(id) {
    var url = baseUrl + "/admin/vendors/reject/doc/"+id;
    if(id){
        Swal.fire({
          title: 'Message!',
