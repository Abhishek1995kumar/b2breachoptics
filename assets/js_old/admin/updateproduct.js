...
{
    url = baseUrl + "/admin/products/vendor_product_update";
    $.ajax({
        type: "POST",
        url: url,
        data: {id:id},
                            ...
                            <div class="modal-content">
                                ...
                                <form action="" id="updateTradeFeatures">
                                    ...
                                    <div class="modal-footer text-center">
                                        <button type="submit" onclick="updateTradeFeatures(event, ${id})" class="btn btn-success">Update</button>
...
function updateTradeFeatures(e, id) {
    ...
    url = baseUrl + "/admin/products/vendor/productupdate";
    $.ajax({
        type: "POST",
        url: url,
        dataType: 'json',
