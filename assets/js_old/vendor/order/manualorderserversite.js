                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel" style="text-align: center;"><b>Order Id: ${order_product_details.order_id}</b> </h4>
                                </div>
                            ...
                            options +=  `<table class="pres-table table-bordered" style="width:100%; outline: 3px;">
                                                                ...
                                                                <td>
                                                                    <center>
                                                                        <a  href="${url1}${order_product_details.presc_image}" target="_blank">
                                                                            <img src="${url1}+${order_product_details.presc_image}" alt="">
                                                                        </a></center>
                                                                </td>
                                                            </tr>`;
                                                        }
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        if(order_product_details.color){
                                            options += `<p> <b>Product Color:-</b> ${order_product_details.color}</p>`;
                                        }
