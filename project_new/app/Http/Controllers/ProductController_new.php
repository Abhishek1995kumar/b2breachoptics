...
class ProductController extends Controller
{
   ...
   public function pendingdetails($id)
   {
    ...
    public function store(Request $request)
    {
        ...
        // echo "<pre>";
        // print_r($data['powermin']);
        
        
        $data['powermax'] = $powernewmax;
        
        // echo "<pre>";
        // print_r($data['powermax']);
        
        
        $data['axisnew'] = $axisneww;
        
        // echo "<pre>";
        // print_r($data['axisnew']);
        
        
        $data['cylindernew'] = $cylinderneww;
        
        // echo "<pre>";
        // print_r($data['cylindernew']);
        
        
        $data['basecurve'] = $basecurvenew;
        
        // echo "<pre>";
        // print_r($data['basecurve']);
        
        
        $data['addpower'] = $addnew;
        
        // echo "<pre>";
        // print_r($data['addpower']);
        // die();
