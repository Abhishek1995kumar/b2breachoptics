          ...
          <nav class="navbar navbar-default">
            <div class="container-fluid">
              <div class="navbar-header" style="padding-top: 15px;">
                <a style="margin-left: 15px;" href="{{url('/home')}}" >{{$language->home}}</a>{{"/"}}
                <a style="margin-left: 15px;" href="{{url('/category')}}/{{\App\Category::where('id',$productdata->category[0])->first()->slug}}">{{\App\Category::where('id',$productdata->category[0])->first()->name}}</a>
                @if($productdata->subid != "")
                    <a style="margin-left: 15px;" href="{{url('/category')}}/{{\App\Category::where('id',$productdata->subid)->first()->slug}}">{{\App\Category::where('id',$productdata->subid)->first()->name}}</a>
                @endif
                @if($productdata->childid != "")
                    <a style="margin-left: 15px;" href="{{url('/category')}}/{{\App\Category::where('id',$productdata->childid)->first()->slug}}">{{\App\Category::where('id',$productdata->childid)->first()->name}}</a>
                @endif
                <a style="margin-left: 15px;" style ="color : black;" href="{{url('/product')}}/{{$productdata->id}}/{{str_replace(' ','-',strtolower($productdata->title))}}">{{$productdata->title}}</a>
              </div>
                            ...
                            <div class="tab-content">
                                        ...
                                        <div id="overview-tab-1" class="tab-pane active fade in">
                                           ...
                                           <!--  <h5>Color</h5><p class="product-size">{{$productdata->color}}</p>
                                            ...
                                            <div class="row">
                                              <h5>Technical Informationnnnnnn</h5>
                                              <ul>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-5 praqty">
                                                    ...
                                                    @if($productdata->category[0] == 58 && $productdata->lenstype == "Spherical")
    ...
    <div class="modal-content">
      ...
      <div class="row">
       @if($productdata->category[0] == 53) 
          <div class="col-md-6">
           <ul>
             <li style="color: #1B1212;">Frame Shape <span style="padding-left: 24%;color: black;">@if($productdata->frameshape ==''): NA @else:  {{$productdata->frameshape}}@endif</span> </li><br>
             <li style="color: #1B1212;">Frame Color <span style="padding-left: 25%; color: black;">@if($productdata->framecolor ==''): NA @else:  {{$productdata->framecolor}}@endif</span></li><br>
             <li style="color: #1B1212;">Gender<span style="padding-left: 34%;color: black;">@if($productdata->gender ==''): NA @else:  {{$productdata->gender}}@endif</span></li><br>
             <li style="color: #1B1212;">Brand Name <span style="padding-left: 23%;color: black;">@if($productdata->brandname ==''): NA @else:  {{$productdata->brandname}}@endif</span></li><br>
             <li style="color: #1B1212;">Model No<span style="padding-left: 29%;color: black;">@if($productdata->modelno ==''): NA @else:  {{$productdata->modelno}}@endif</span></li><br>
             <li style="color: #1B1212;">Product Sku <span style="padding-left: 23%;color: black;">@if($productdata->productsku ==''): NA @else:  {{$productdata->productsku}}@endif</span></li><br>
             <li style="color: #1B1212;">Frame Style <span style="padding-left: 24%;color: black;">@if($productdata->framestyle ==''): NA @else:  {{$productdata->framestyle}}@endif</span></li><br>
             <li style="color: #1B1212;">Frame Material <span style="padding-left: 19%;color: black;">@if($productdata->framematerial ==''): NA @else:  {{$productdata->framematerial}}@endif</span></li><br>
           </ul>
          </div>
          <div class="col-md-6">
            <ul>
             <li style="color: #1B1212;">Frame Width<span style="padding-left: 27%; color: black;">@if($productdata->framewidth ==''): NA @else:  {{$productdata->framewidth}}@endif</span> </li><br>
             <li style="color: #1B1212;">Height <span style="padding-left: 37%; color: black;">@if($productdata->height ==''): NA @else:  {{$productdata->height}}@endif</span></li><br>
             <li style="color: #1B1212;">Temple Material <span style="padding-left: 21%; color: black;">@if($productdata->templematerial ==''): NA @else:  {{$productdata->templematerial}}@endif</span></li><br>
             <li style="color: #1B1212;">Temple Color<span style="padding-left: 27%; color: black;">@if($productdata->templecolor ==''): NA @else:  {{$productdata->templecolor}}@endif</span></li><br>
             <li style="color: #1B1212;">Conditions <span style="padding-left: 30%; color: black;">@if($productdata->conditionsnew ==''): NA @else:  {{$productdata->conditionsnew}}@endif</span></li><br>
             <li style="color: #1B1212;">Frame Type<span style="padding-left: 29%; color: black;">@if($productdata->frametype ==''): NA @else:  {{$productdata->frametype}}@endif</span></li><br>
             <li style="color: #1B1212;">Frame Dimensions <span style="padding-left: 16%; color: black;">@if($productdata->productdimension ==''): NA @else:  {{$productdata->productdimension}}@endif</span></li><br>
             <li style="color: #1B1212;">Warrenty Type<span style="padding-left: 24%; color: black;">@if($productdata->warrentytype ==''): NA @else:  {{$productdata->warrentytype}}@endif</span></li><br>
              <li style="color: #1B1212;">Manufracturer<span style="padding-left: 24%;color: black;">@if($productdata->manufracturer ==''): NA @else:  {{$productdata->manufracturer}}@endif</span></li><br>
              <li style="color: #1B1212;">Weight <span style="padding-left: 35%;color: black;">@if($productdata->weight ==''): NA @else:  {{$productdata->weight}}@endif</span></li><br>
              <li style="color: #1B1212;">Country Of Origin<span style="padding-left: 19%;color: black;">@if($productdata->countryoforigin ==''): NA @else:  {{$productdata->countryoforigin}}@endif</span></li><br>
            </ul>
          </div>
        @elseif($productdata->category[0] == 58)
          <div class="col-md-6">
             <ul>
               <li style="color: #1B1212;">Brand Name <span style="padding-left: 25%;color: black;">@if($productdata->brandname ==''): NA @else:  {{$productdata->brandname}}@endif</span> </li><br>
               <li style="color: #1B1212;">Product Sku <span style="padding-left: 25%; color: black;">@if($productdata->productsku ==''): NA @else:  {{$productdata->productsku}}@endif</span></li><br>
               <li style="color: #1B1212;">Lens Material<span style="padding-left: 24%;color: black;">@if($productdata->lensmaterialtype ==''): NA @else:  {{$productdata->lensmaterialtype}}@endif</span></li><br>
               <li style="color: #1B1212;">Diameter<span style="padding-left: 30%;color: black;">@if($productdata->diameter ==''): NA @else:  {{$productdata->diameter}}@endif</span></li><br>
               <li style="color: #1B1212;">Lens Color<span style="padding-left: 28%;color: black;">@if($productdata->lenscolor ==''): NA @else:  {{$productdata->lenscolor}}@endif</span></li><br>
               <li style="color: #1B1212;">Lens index <span style="padding-left: 26%;color: black;">@if($productdata->lensindex ==''): NA @else:  {{$productdata->lensindex}}@endif</span></li><br>
             </ul>
            </div>
            <div class="col-md-6">
              <ul>
               <li style="color: #1B1212;">Focal Length<span style="padding-left: 29%; color: black;">@if($productdata->focallength ==''): NA @else:  {{$productdata->focallength}}@endif</span> </li><br>
               <li style="color: #1B1212;">Manufracturer<span style="padding-left: 26%; color: black;">@if($productdata->manufracturer ==''): NA @else:  {{$productdata->manufracturer}}@endif</span></li><br>
               <li style="color: #1B1212;">Weight<span style="padding-left: 38%; color: black;">@if($productdata->weight ==''): NA @else:  {{$productdata->weight}}@endif</span></li><br>
               <li style="color: #1B1212;">Country Of Origin<span style="padding-left: 22%; color: black;">@if($productdata->countryoforigin ==''): NA @else:  {{$productdata->countryoforigin}}@endif</span></li><br>
               <li style="color: #1B1212;">Gravity<span style="padding-left: 39%; color: black;">@if($productdata->gravity ==''): NA @else:  {{$productdata->gravity}}@endif</span></li><br>
               <li style="color: #1B1212;">Coating Color<span style="padding-left: 28%; color: black;">@if($productdata->coatingcolor ==''): NA @else:  {{$productdata->coatingcolor}}@endif</span></li><br>
               <li style="color: #1B1212;">Abbe Value<span style="padding-left: 32%; color: black;">@if($productdata->abbevalue ==''): NA @else:  {{$productdata->abbevalue}}@endif</span></li><br>
              </ul>
            </div>
        @elseif($productdata->category[0] == 63) 
           <div class="col-md-6">
           <ul>
             <li style="color: #1B1212;">Frame Shape <span style="padding-left: 24%;color: black;">@if($productdata->frameshape ==''): NA @else:  {{$productdata->frameshape}}@endif</span> </li><br>
             <li style="color: #1B1212;">Frame Color <span style="padding-left: 26%; color: black;">@if($productdata->framecolor ==''): NA @else:  {{$productdata->framecolor}}@endif</span></li><br>
             <li style="color: #1B1212;">Gender<span style="padding-left: 35%;color: black;">@if($productdata->gender ==''): NA @else:  {{$productdata->gender}}@endif</span></li><br>
             <li style="color: #1B1212;">Brand Name <span style="padding-left: 25%;color: black;">@if($productdata->brandname ==''): NA @else:  {{$productdata->brandname}}@endif</span></li><br>
             <li style="color: #1B1212;">Model No<span style="padding-left: 31%;color: black;">@if($productdata->modelno ==''): NA @else:  {{$productdata->modelno}}@endif</span></li><br>
             <li style="color: #1B1212;">Product Sku <span style="padding-left: 26%;color: black;">@if($productdata->productsku ==''): NA @else:  {{$productdata->productsku}}@endif</span></li><br>
             <li style="color: #1B1212;">Frame Style <span style="padding-left: 27%;color: black;">@if($productdata->framestyle ==''): NA @else:  {{$productdata->framestyle}}@endif</span></li><br>
             <li style="color: #1B1212;">Frame Material <span style="padding-left: 22%;color: black;">@if($productdata->framematerial ==''): NA @else:  {{$productdata->framematerial}}@endif</span></li><br>
           </ul>
          </div>
          <div class="col-md-6">
            <ul>
             <li style="color: #1B1212;">Frame Width<span style="padding-left: 23%; color: black;">@if($productdata->framewidth ==''): NA @else:  {{$productdata->framewidth}}@endif</span> </li><br>
             <li style="color: #1B1212;">Height <span style="padding-left: 33%; color: black;">@if($productdata->height ==''): NA @else:  {{$productdata->height}}@endif</span></li><br>
             <li style="color: #1B1212;">Temple Material <span style="padding-left: 18%; color: black;">@if($productdata->templematerial ==''): NA @else:  {{$productdata->templematerial}}@endif</span></li><br>
             <li style="color: #1B1212;">Temple Color<span style="padding-left: 24%; color: black;">@if($productdata->templecolor ==''): NA @else:  {{$productdata->templecolor}}@endif</span></li><br>
             <li style="color: #1B1212;">Lens Material <span style="padding-left: 23%; color: black;">@if($productdata->lensmaterialtype ==''): NA @else:  {{$productdata->lensmaterialtype}}@endif</span></li><br>
             <li style="color: #1B1212;">Lens Color<span style="padding-left: 29%; color: black;">@if($productdata->lenscolor ==''): NA @else:  {{$productdata->lenscolor}}@endif</span></li><br>
             <li style="color: #1B1212;">Conditions <span style="padding-left: 28%; color: black;">@if($productdata->conditionsnew ==''): NA @else:  {{$productdata->conditionsnew}}@endif</span></li><br>
             <li style="color: #1B1212;">Lens Technology<span style="padding-left: 19%; color: black;">@if($productdata->warrentytype ==''): NA @else:  {{$productdata->warrentytype}}@endif</span></li><br>
              <li style="color: #1B1212;">Frame Type<span style="padding-left: 27%;color: black;">@if($productdata->manufracturer ==''): NA @else:  {{$productdata->manufracturer}}@endif</span></li><br>
              <li style="color: #1B1212;">Manufracturer<span style="padding-left: 22%;color: black;">@if($productdata->weight ==''): NA @else:  {{$productdata->weight}}@endif</span></li><br>
              <li style="color: #1B1212;">Warrenty Type<span style="padding-left: 22%;color: black;">@if($productdata-> warrentytype ==''): NA @else:  {{$productdata-> warrentytype}}@endif</span></li><br>
              <li style="color: #1B1212;">Frame Dimension<span style="padding-left: 16%;color: black;">@if($productdata->productdimension ==''): NA @else:  {{$productdata->productdimension}}@endif</span></li><br>
              <li style="color: #1B1212;">Weight<span style="padding-left: 34%;color: black;">@if($productdata->weight ==''): NA @else:  {{$productdata->weight}}@endif</span></li><br>
              <li style="color: #1B1212;">Country Of Origin<span style="padding-left: 17%;color: black;">@if($productdata->countryoforigin ==''): NA @else:  {{$productdata->countryoforigin}}@endif</span></li><br>
            </ul>
          </div> 
        @elseif($productdata->category[0] == 87)
          ...
          <div class="col-md-6">
           <ul>
             <li style="color: #1B1212;">Brand Name <span style="padding-left: 22%;color: black;">@if($productdata->brandname ==''): NA @else:  {{$productdata->brandname}}@endif</span> </li><br>
             <li style="color: #1B1212;">Product Sku <span style="padding-left: 23%; color: black;">@if($productdata->productsku ==''): NA @else:  {{$productdata->productsku}}@endif</span></li><br>
             <li style="color: #1B1212;"> Net Quantity<span style="padding-left: 23%;color: black;">@if($productdata->netquntity ==''): NA @else:  {{$productdata->netquntity}}@endif</span></li><br>
             <li style="color: #1B1212;">Shelf Life <span style="padding-left: 28%;color: black;">@if($productdata->shelflife ==''): NA @else:  {{$productdata->shelflife}}@endif</span></li><br>
             <li style="color: #1B1212;">Form<span style="padding-left: 35%;color: black;">@if($productdata->form ==''): NA @else:  {{$productdata->form}}@endif</span></li><br>
             <li style="color: #1B1212;">Product Color <span style="padding-left: 20%;color: black;">@if($productdata->productcolor ==''): NA @else:  {{$productdata->productcolor}}@endif</span></li><br>
           </ul>
          </div>
          <div class="col-md-6">
            <ul>
             <li style="color: #1B1212;">Product Dimension<span style="padding-left: 22%; color: black;">@if($productdata->productdimension ==''): NA @else:  {{$productdata->productdimension}}@endif</span> </li><br>
             <li style="color: #1B1212;">Material <span style="padding-left: 40%; color: black;">@if($productdata->material ==''): NA @else:  {{$productdata->material}}@endif</span></li><br>
             <li style="color: #1B1212;">Manufracturer <span style="padding-left: 29%; color: black;">@if($productdata->manufracturer ==''): NA @else:  {{$productdata->manufracturer}}@endif</span></li><br>
             <li style="color: #1B1212;">Warrenty Type<span style="padding-left: 30%; color: black;">@if($productdata->warrentytype ==''): NA @else:  {{$productdata->warrentytype}}@endif</span></li><br>
             <li style="color: #1B1212;">Weight <span style="padding-left: 41%; color: black;">@if($productdata->weight ==''): NA @else:  {{$productdata->weight}}@endif</span></li><br>
             <li style="color: #1B1212;">Country Of Origin<span style="padding-left: 25%; color: black;">@if($productdata->countryoforigin ==''): NA @else:  {{$productdata->countryoforigin}}@endif</span></li><br>
            </ul>
          </div>
        @elseif($productdata->category[0] == 72) 
          ...
          <div class="col-md-6">
           <ul>
             <li style="color: #1B1212;">Brand Name <span style="padding-left: 24%;color: black;">@if($productdata->brandname ==''): NA @else:  {{$productdata->brandname}}@endif</span> </li><br>
             <li style="color: #1B1212;">Product Sku <span style="padding-left: 25%; color: black;">@if($productdata->productsku ==''): NA @else:  {{$productdata->productsku}}@endif</span></li><br>
             <li style="color: #1B1212;">Model No<span style="padding-left: 30%;color: black;">@if($productdata->modelno ==''): NA @else:  {{$productdata->modelno}}@endif</span></li><br>
             <li style="color: #1B1212;">Usages Duration <span style="padding-left: 17%;color: black;">@if($productdata->usagesduration ==''): NA @else:  {{$productdata->usagesduration}}@endif</span></li><br>
             <li style="color: #1B1212;">Diameter<span style="padding-left: 30%;color: black;">@if($productdata->diameter ==''): NA @else:  {{$productdata->diameter}}@endif</span></li><br>
             <li style="color: #1B1212;">Contact Lens Material<span style="padding-left: 9%;color: black;">@if($productdata->contactlensmaterialtype ==''): NA @else:  {{$productdata->contactlensmaterialtype}}@endif</span></li><br>
           </ul>
          </div>
          <div class="col-md-6">
            <ul>
             <li style="color: #1B1212;">Base Curve<span style="padding-left: 28%; color: black;">@if($productdata->basecurve ==''): NA @else:  {{$productdata->basecurve}}@endif</span> </li><br>
             <li style="color: #1B1212;">water content<span style="padding-left: 23%; color: black;">@if($productdata->watercontent ==''): NA @else:  {{$productdata->watercontent}}@endif</span></li><br>
             <li style="color: #1B1212;">Power <span style="padding-left: 35%; color: black;">@if($productdata->power ==''): NA @else:  {{$productdata->power}}@endif</span></li><br>
             <li style="color: #1B1212;">Disposability<span style="padding-left: 25%; color: black;">@if($productdata->disposability ==''): NA @else:  {{$productdata->disposability}}@endif</span></li><br>
             <li style="color: #1B1212;">Packaging<span style="padding-left: 29%; color: black;">@if($productdata->packaging ==''): NA @else:  {{$productdata->packaging}}@endif</span></li><br>
             <li style="color: #1B1212;">Lens Color<span style="padding-left: 30%; color: black;">@if($productdata->lenscolor ==''): NA @else:  {{$productdata->lenscolor}}@endif</span></li><br>
             <li style="color: #1B1212;">Lens Manufracturer<span style="padding-left: 15%; color: black;">@if($productdata->manufracturer ==''): NA @else:  {{$productdata->manufracturer}}@endif</span></li><br>
             <li style="color: #1B1212;">Country Of Origin<span style="padding-left: 19%; color: black;">@if($productdata->countryoforigin ==''): NA @else:  {{$productdata->countryoforigin}}@endif</span></li><br>
            </ul>
          </div>
