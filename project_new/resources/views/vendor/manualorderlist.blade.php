            ...
            <div class="row" id="main">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="col-md-4 mb-4" style="margin-bottom: 1rem;">
                            <select class="form-control" onchange="filterCategoryWise(event)" id="categoryValue">
                        ...
                        <div class="col-md-12">
                            <div class="tab" role="tabpanel">
                                    <ul class="nav nav-tabs" id="order_process_tab" role="tablist">
