            ...
            <div class="row">
                ...
                <div class="text-center">
                    <div class="pull-right">
                        <a href="{!! url('vendor/cancelorders') !!}" class="btn btn-default btn-back"><i class="fa fa-arrow-left"></i> Back</a>
                    </div>
                    <h1>Order Details</h1>
                    <hr>
                </div>
                    ...
                    <div class="card mb-3" style="max-width: 100%;">
                          <div class="row no-gutters">
                            ...
                            <div class="col-md-4">
                             ...
                             <p>Order Id:- {{$allcanceldata->orderid}}</p>
    ...
    <div class="container pb-5 mb-sm-4">
        ...
        <div class="row mb-3">
            <div class="col-sm-4 mb-2">
                <div class="bg-secondary p-4 text-dark text-center" style="padding-top: 12px;"><span class="font-weight-semibold mr-2">Status :</span> Cancelled</div>
            </div>
            <div class="col-sm-4 mb-2">
                <!-- <div class="bg-secondary p-4 text-dark text-center" style="padding-top: 12px;"><span class="font-weight-semibold mr-2">Status:</span></div> -->
            </div>
            <div class="col-sm-4 mb-2">
        ...
        <div class="steps">
            ...
            <div class="steps-body">
                ...
                <div class="step step-active"><span class="step-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-award"><circle cx="12" cy="8" r="7"></circle><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"></polyline></svg></span>Shipped<br>{{$allcanceldata->pickup_date}}</div>
                <div class="step"><span class="step-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-truck"><rect x="1" y="3" width="15" height="13"></rect><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"></polygon><circle cx="5.5" cy="18.5" r="2.5"></circle><circle cx="18.5" cy="18.5" r="2.5"></circle></svg></span>Out Of Delivery<br>{{$allcanceldata->intransit_date}}</div>
                <div class="step"><span class="step-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg></span>Product delivered<br>{{$allcanceldata->order_confirm_date}}</div>
            </div>
        </div>
    </div>
 @endif
...
<!-- cancel order tracking  view -->
    ...
    @if($allcanceldata->status == 'cancelled' || $allcanceldata->status == 'declined')
