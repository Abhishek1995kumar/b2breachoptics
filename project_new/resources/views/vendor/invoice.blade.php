...
<body>
    ...
    <div class="invoice_header">
        ...
        <tr>
            ...
            <td align="left" style="width: 50%;">
                <h3 class="text-dark" style="margin-bottom:10px; font-sixe:20px; font-weight:900;">{{Auth::guard('vendor')->user()->shop_name}}</h3>
                <div>{{Auth::guard('vendor')->user()->address}}</div>
                <div>{{Auth::guard('vendor')->user()->areaandstreet}}</div>
                <div>Email: {{Auth::guard('vendor')->user()->email}}</div>
                <div>Phone: {{Auth::guard('vendor')->user()->phone}}</div>
            </td>
        </tr>
    </table>
    </div>
    ...
    <div class="padding_left_right customer_address_div">
        ...
        <tr>
            <td align="left" style="width: 50%;">
                ...
                <p><b>{{$orders->buyer_name}}</b><br>
                    {{$orders->buyer_address}}<br>
                    {{$orders->buyer_address2}}<br>
                    {{$orders->Cname}} {{$orders->Sname}}<br>
                    {{$orders->country}} 
    ...
    <div class="padding_left_right">
        ...
        <tbody >
            <tr>
                ...
                <td style="padding: 10px;" colspan="2" class="text-right">{{$orders->cost_price}}</td>
