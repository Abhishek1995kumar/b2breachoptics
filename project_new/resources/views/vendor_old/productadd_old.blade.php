                    ...
                    <div class="panel-body">
                        ...
                        <!--<form method="POST" action="{!! action('VendorProductsController@store') !!}" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>-->
                            ...
                            <div class="item form-group" id="colornew">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control" name="framecolor" id="color" required>
                            ...
                            <div class="item form-group" id="lenscolornew">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control" name="color" id="lenscolor" >
                                        ...
                                        <option value="PFX Pioneer" {{ old('lenscolor') == "PFX Pioneer" ? 'selected' : '' }}>PFX Pioneer</option>
                                    </select>
                                </div>
                            </div>

                            <div class="item form-group" id="contactlenscolornew">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="lenscolor">Contact Lens Color <span class="required" style="color:red;">*</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
...
<!-- 
 ...
 -->
                           ...
                           <!--  <div class="item form-group">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12"> Product Selling Price <span class="required" style="color:red;">*
                                    
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" id="pro_costprice" value="{{old('costprice')}}" name="costprice" placeholder="e.g 25" pattern="[0-9]+(\.[0-9]{0,2})?%?"
                                           title="Price must be a numeric or up to 2 decimal places." type="number">
                                </div>
                            </div>
...
<script>
	...
	function frameValidation()
	{
	    ...
	    {
	        alert("Please Fill Product Selling Price Filed");
	        $('#pro_costprice').focus();
	        return false;
	    }
	    if($('#pro_stock').val() == '')
