                    ...
                    <div class="panel-body">
                        ...
                        <!--<form method="POST" action="{!! action('VendorProductsController@update',['id' => $product->id]) !!}" class="form-horizontal form-label-left" enctype="multipart/form-data">-->
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control" name="mainid" id="maincats" onmousedown="return false" onkeydown="return false">
                          ...
                          <div class="item form-group">
                            ...
                            <div class="item form-group" id="colornew">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="color">Frame Color <span class="required" style="color:red;">*</span></label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    ?>
                                     <select class="form-control" multiple="multiple" name="addpowerlens[]" id="addpowerlens">
                                        @foreach($lenses_data as $value)
                                            <!--@if (in_array($value->add_power, $arrSpecialityadd) || in_array($value->id, $arrSpecialityadd))-->
                            ...
                            <div class="item form-group" id="diameterlenss">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <?php
                                        $arrSpecialityadd = explode(',',$product->diameterlens);
                                    ?>
                                     <select class="form-control" multiple="multiple" name="diameterlens[]" id="diameterlens">
                                        @foreach($lenses_data as $value)
                                            @if (in_array($value->diameter, $arrSpecialityadd) || in_array($value->id, $arrSpecialityadd))
                            ...
                            <div class="item form-group" id="spheres">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <select class="form-control" multiple="multiple" name="sphere[]" id="spherelens">
                                        @foreach($lenses_data as $value)
                                            @if (in_array($value->sphere, $arrSpecialitysphere) || in_array($value->id, $arrSpecialitysphere))
                            ...
                            <div class="item form-group" id="axisnlenss">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <?php
                                        $arrSpeciality = explode(',',$product->axisnlens);
                                    ?>
                                    <select class="form-control" multiple="multiple" name="axisnlens[]" id="axisnlens" >
                                        @foreach($lenses_data as $value)
                                            @if (in_array($value->axis, $arrSpeciality) || in_array($value->id, $arrSpeciality))
                            ...
                            <div class="item form-group" id="cylinderlenss">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <?php
                                        $arrSpecialitycylinders = explode(',',$product->cylinderlens);
                                        
                                    ?>
                                    <select class="form-control" multiple="multiple" name="cylinderlens[]" id="cylinderlens" >
                                        @foreach($lenses_data as $value)
                                            @if (in_array($value->cylinder, $arrSpecialitycylinders) || in_array($value->id, $arrSpecialitycylinders))
                            ...
                            <div class="item form-group" id="lensmaterialtypenew">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control" name="lensmaterialtype" id="lensmaterialtype" >
                                    	<option value="{{$lens_material[0]->name}}">{{$lens_material[0]->name}}</option>
                            ...
                            <div class="item form-group" id="lenstechnologynew">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control" name="lenstechnology" id="lenstechnology" >
                                    	<option value="{{$lenstechnology[0]->name}}">{{$lenstechnology[0]->name}}</option>
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Product Selling Price <span class="required" style="color:red;">*</span>
...
$(document).ready(function() {
    ...
    $("#productFormSubmit").on("submit", function(e){
        ...
        if(validate()){
            $.ajax({
                method: 'POST',
                url: "{{url('vendor/products/update/')}}",
                data: formData,
	...
	function frameValidation()
	{
	   ...
	   // }
	    ...
	    {
	        alert("Please Fill Product Cost Price Filed");
	        $('#pro_costprice').focus();
	        return false;
	    }
	    if($('#pro_stock').val() == '')
	...
	function SunglassValidation()
	{
	    ...
	    {
	        alert("Please Fill Lens Material Filed");
	    ...
	    if($('#sellername').val() == '')
	    {
	        alert("Please Fill Seller Name Filed");
	        $('#sellername').focus();
	        return false;
	    }
	    if($('#framematerial').val() == '')
	...
	function ContaclensValidation()
	{
	    ...
	    if($('#lenstype').val() == '')
	    {
	        alert("Please Select Contact Lens Type");
	        $('#lenstype').focus();
	        return false;
    	    ...
    	    {
    	        alert("Please Select At Least One Diameter");
    	        $('#diameter').focus();
    	        return false;
    	    }
    	    if($('#basecurve').val().length == 0)
    	    {
    	        alert("Please Select At Least One Basecurve");
    	        $('#basecurve').focus();
    	        return false;
    	    }
    	    if($('#powermin').val().length == 0)
    	    {
    	        alert("Please Select At Least One Sphere Power (-)");
    	        $('#powermin').focus();
    	        return false;
    	    }
    	    ...
    	    {
    	        alert("Please Select At Least One Add Power");
    	        $('#addpower').focus();
    	        return false;
    	    }
	    }else if($('#lenstype').val() == 'toric and Astigmatism'){
    	    ...
    	    if($('#cylindernew').val() == '')
    	    {
    	        alert("Please Fill Cylinder Lens Filed");
    	        $('#cylindernew').focus();
    	        return false;
    	    }
	   ...
	   // }
	    ...
	    if($('#packaging').val() == '')
	    {
	        alert("Please Fill Packaging Filed");
	        $('#packaging').focus();
	        return false;
	    }
	    return true;
