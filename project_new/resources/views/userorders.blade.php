                    ...
                    <div class="dashboard-content">
                        <div id="my-orders-tab">
                            ...
                            <ul class="nav nav-tabs nav-justified nav-tabs-dropdown" role="tablist">
							    ...
							    <li role="presentation"><a href="#sub_user_orders" onclick="subuserorder()" aria-controls="userorder" role="tab" data-toggle="tab">CHILD USER ORDER</a></li>
						    </ul>
...
<script>
    ...
    function subuserorder(){
        $("#userOrders").DataTable({
            ...
            'colReorder': true,
            'ajax': {
                'url': "{{url('/user/orders/get_active_subuserorder_details')}}",
                'method' : 'POST',
                'data': {
                  "_token": "{{ csrf_token() }}"
              },
