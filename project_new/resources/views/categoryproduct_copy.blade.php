...
<link rel="stylesheet" type="text/css" href="{{url('/assets/css/test.scss')}}">
    ...
    <div class="home-wrapper" style="overflow: hidden">
        <div class="container-fluid">
            <img class="bannar-image" src="{{url('/assets')}}/images/categories/{{$category->feature_image}}" style="border-radius : 1.25rem; background-position: center center; background-repeat: no-repeat; background-size: auto">
            <!--<section class="bannar-image" style="background: url({{url('/assets')}}/images/categories/{{$category->feature_image}}); border-radius : 1.25rem; background-position: center center; background-repeat: no-repeat; background-size: auto">-->
                <!--<section>-->
                                        ...
                                        <h3 class="filter-title">Filter Option</h3>
                                            ...
                                            <!-- gender filter -->
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="dropdown-check-list filter-product " tabindex="100" data-filter='color'>
                                                                    <ul class="items">
                                                                        ...
                                                                        <!--<li>-->
                                                                        <!--    <input type="checkbox" class="form-check-input" name='framecolor[]' value="GOLDEN" @if(!empty($framecolor) && in_array('GOLDEN', explode(',',$framecolor))) checked @endif> GOLDEN-->
                                                                        <!--</li>-->
                                                                        <!--<li>-->
                                                                        <!--    <input type="checkbox" class="form-check-input" name='framecolor[]' value="WHITE" @if(!empty($framecolor) && in_array('WHITE', explode(',',$framecolor))) checked @endif> White-->
                                                                        <!--</li>-->
                                                                        <!--<li>-->
                                                                        <!--    <input type="checkbox" class="form-check-input" name='framecolor[]' value="BROWN" @if(!empty($framecolor) && in_array('BROWN', explode(',',$framecolor))) checked @endif> BROWN-->
                                                                        <!--</li>-->
                                                                        <!--<li>-->
                                                                        <!--    <input type="checkbox" class="form-check-input" name='framecolor[]' value="RED" @if(!empty($framecolor) && in_array('RED', explode(',',$framecolor))) checked @endif> RED-->
                                                                        <!--</li>-->
                                                                        <!--<li>-->
                                                                        <!--    <input type="checkbox" class="form-check-input" name='framecolor[]' value="Turtoise" @if(!empty($framecolor) && in_array('Turtoise', explode(',',$framecolor))) checked @endif> Turtoise-->
                                                                        <!--</li>-->
                                                                        <!--<li>-->
                                                                        <!--    <input type="checkbox" class="form-check-input" name='framecolor[]' value="Blue" @if(!empty($framecolor) && in_array('Blue', explode(',',$framecolor))) checked @endif> Blue-->
                                                                        <!--</li>-->
                                                                        <!--<li>-->
                                                                        <!--    <input type="checkbox" class="form-check-input" name='framecolor[]' value="Silver" @if(!empty($framecolor) && in_array('Silver', explode(',',$framecolor))) checked @endif> Silver-->
                                                                        <!--</li>-->
                                                                        <!--<li>-->
                                                                        <!--    <input type="checkbox" class="form-check-input" name='framecolor[]' value="Grey" @if(!empty($framecolor) && in_array('Grey', explode(',',$framecolor))) checked @endif> Grey-->
                                                                        <!--</li>-->
                                                                        <!--<li>-->
                                                                        <!--    <input type="checkbox" class="form-check-input" name='framecolor[]' value="Gunmetal" @if(!empty($framecolor) && in_array('Gunmetal', explode(',',$framecolor))) checked @endif> Gunmetal-->
                                                                        <!--</li>-->
                                                                        <!--<li>-->
                                                                        <!--    <input type="checkbox" class="form-check-input" name='framecolor[]' value="Pink" @if(!empty($framecolor) && in_array('Pink', explode(',',$framecolor))) checked @endif> Pink-->
                                                                        <!--</li>-->
                                                                        <!--<li>-->
                                                                        <!--    <input type="checkbox" class="form-check-input" name='framecolor[]' value="Beige" @if(!empty($framecolor) && in_array('Beige', explode(',',$framecolor))) checked @endif> Beige -->
                                                                        <!--</li>-->
                                                                        <!--<li>-->
                                                                        <!--    <input type="checkbox" class="form-check-input" name='framecolor[]' value="green" @if(!empty($framecolor) && in_array('green', explode(',',$framecolor))) checked @endif> Green-->
                                                                        <!--</li>-->
                                                                        <!--<li>-->
                                                                        <!--    <input type="checkbox" class="form-check-input" name='framecolor[]' value="Purple" @if(!empty($framecolor) && in_array('Purple', explode(',',$framecolor))) checked @endif> Purple-->
                                                                        <!--</li>-->
                                                                        <!--<li>-->
                                                                        <!--    <input type="checkbox" class="form-check-input" name='framecolor[]' value="Multicolor" @if(!empty($framecolor) && in_array('Multicolor', explode(',',$framecolor))) checked @endif> Multicolor-->
                                                                        <!--</li>-->
                                                                        <!--<li>-->
                                                                        <!--    <input type="checkbox" class="form-check-input" name='framecolor[]' value="Rose Gold" @if(!empty($framecolor) && in_array('Rose Gold', explode(',',$framecolor))) checked @endif> Rose Gold-->
                                                                        <!--</li>-->
                                                                        <!--<li>-->
                                                                        <!--    <input type="checkbox" class="form-check-input" name='framecolor[]' value="yellow" @if(!empty($framecolor) && in_array('yellow', explode(',',$framecolor))) checked @endif> Yellow-->
                                                                        <!--</li>-->
                                                                        <!--<li>-->
                                                                        <!--    <input type="checkbox" class="form-check-input" name='framecolor[]' value="Maroon" @if(!empty($framecolor) && in_array('Maroon', explode(',',$framecolor))) checked @endif> Maroon-->
                                                                        <!--</li>-->
                                                                        <!--<li>-->
                                                                        <!--    <input type="checkbox" class="form-check-input" name='framecolor[]' value="Transparent" @if(!empty($framecolor) && in_array('Transparent', explode(',',$framecolor))) checked @endif> Transparent-->
                                                                        <!--</li>-->
                                                                        @endforeach
                                                                    </ul>
                                                                </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="dropdown-check-list filter-product " tabindex="100" data-filter='color'>
                                                                    <ul class="items">
                                                                        <li>
                                                                            <input type="checkbox" class="form-check-input" name='framecolor[]' value="Black" @if(!empty($framecolor) && in_array('Black', explode(',',$framecolor))) checked @endif> Black
                                                                        </li>
                                                                        <li>
                                                                            <input type="checkbox" class="form-check-input" name='framecolor[]' value="GOLDEN" @if(!empty($framecolor) && in_array('GOLDEN', explode(',',$framecolor))) checked @endif> GOLDEN
                                                                        </li>
                                                ...
                                                @elseif($products[0]->category[0] == 82)
                                                    ...
                                                    <!--                <ul class="items">-->
                                                    <!--                  <li><input type="checkbox" class="form-check-input" name='premiumtype[]' value="Frames" @if(!empty($brandname) && in_array('Frames', explode(',',$brandname))) checked @endif /> Frames </li>-->
                                                    <!--                  <li><input type="checkbox" class="form-check-input" name='premiumtype[]' value="Sunglasses" @if(!empty($brandname) && in_array('Sunglasses', explode(',',$brandname))) checked @endif />  Sunglasses </li>-->
                                                    <!--                </ul>-->
                                                    <!--            </div>-->
                                                    <!--        </div>-->
                                                    <!--    </div>-->
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <span class="anchor" style="padding:3.5rem;"><b>Net Quantity</b></span>   
                                                             <div class="dropdown-check-list filter-product " tabindex="100" data-filter='lenscolor'>
                                                              ...
                                                              <li><input type="checkbox" class="form-check-input" name='netquntity[]' value="355 ML" @if(!empty($netquntity) && in_array('355 ML', explode(',',$netquntity))) checked @endif />  355 ML </li>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 single_product">
                                        <div class="single-product-carousel-item">
                                            <div class="image_latest_product_shubh">
                                                ...
                                                <a class="img-top" href="{{url('/product')}}/{{$product->id}}/{{str_replace('/','',strtolower($product->title))}}" target="_blank"> <img src="@if(!empty($gallery)){{url('/assets/images/gallery')}}/{{$gallery[0]['image']}}@endif" src1="assets/images/subscription-form/subscibe_image.jpg" alt="Product Image" /> </a>
                                            </div>
...
<script>
    ...
    function runProductFilter(){
        ...
        window.location = "{{url('/category')}}/"+slug+"?sort="+sort+"&colors="+colors+"&shapes="+shapes+"&makes="+makes+"&gender="+gender+"&frametype="+frametype+"&framematerial="+framematerial+"&framecolor="+framecolor+"&lenscolor="+lenscolor+"&size="+size+"&brandname="+brandname+"&lenstype="+lenstype+"&disposability="+disposability+"&packaging="+packaging+"&lensmaterialtype="+lensmaterialtype+"&lenstechnology="+lenstechnology+"&lensindex="+lensindex+"&visioneffect="+visioneffect+"&lensestype="+lensestype+"&radd="+radd+"&rsph="+rsph+"&rcyl="+rcyl+"&raxis="+raxis+"&ladd="+ladd+"&lsph="+lsph+"&lcyl="+lcyl+"&laxis="+laxis+"&ldia="+ldia+"&rdia="+rdia+"&netquntity="+netquntity;
    }
