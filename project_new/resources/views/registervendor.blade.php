    ...
    <div class="container1">
        ...
        <form id="registrationForm" method="post" enctype="multipart/form-data">
            ...
            <div class="main-user-info" id="main">
                ...
                <div class="btn-box">
                    <button type="button" id="next1" onclick="registration_half_details(event)">Next</button>  
                </div>
            </div>
...
<!-- here start -->
<script>
  function registration_half_details(e) {
    const emailFormat = document.getElementById("reg_email").value;
    const emailPatten = /^\S+@\S+\.\S+$/;
    const number = document.getElementById("reg_Pnumber").value;
    const zipPattern = /^([0-9]{10})$/;
    if($('#first_name').val() == ''){
        Swal.fire({
            title: 'Fill First Name !',
    ...
    if(!emailPatten.test(emailFormat)){
        Swal.fire({
...
<script type="text/javascript">
    ...
    const vendor_register_validate = ()=> { // fat arrow function 
        const pass = document.getElementById("reg_password").value;
        const cpass = document.getElementById("confirm_password").value;
        const passworPatten = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,20}$/;
        
        const zip = document.getElementById("zip").value;
        const zipPattern = /^([0-9]{6})$/;
        
        // lete data = [];
        // data[0] = document.getElementById("country-dropdown").value;
        // data[0] = document.getElementById("state-dropdown").value;
        // data[0] = document.getElementById("city-dropdown").value;
        // data[0] = document.getElementById("zip").value;
        ...
        if(!zipPattern.test(zip)){
            Swal.fire({
                title: 'Please Fill Zip !',
                text: 'Please Enter Valid Pin Number ',
                imageUrl: 'https://ci3.googleusercontent.com/proxy/eR2Wo8Rz--CKyxFOPCz0Jq3g-IxKwTSD3G9GJxyNO_2KkmBWqxDKfB8n8vfhhcB3AX0AUHmwGu3YjJy_PVL39aGY2_3l-0-OnUz5V6UA=s0-d-e1-ft#http://eyevam.in/userfiles/company/16202938661299798774.png',
                imageWidth: 400,
                imageHeight: 200,
                imageAlt: 'Custom image',
        ...
        if(!passworPatten.test(pass)){
            Swal.fire({
                title: 'Please Enter Valid Passworrd !',
                text: 'Minimum eight and maximum 20 characters, at least one uppercase letter, one lowercase letter, one number and one special character: !!',
                imageUrl: 'https://ci3.googleusercontent.com/proxy/eR2Wo8Rz--CKyxFOPCz0Jq3g-IxKwTSD3G9GJxyNO_2KkmBWqxDKfB8n8vfhhcB3AX0AUHmwGu3YjJy_PVL39aGY2_3l-0-OnUz5V6UA=s0-d-e1-ft#http://eyevam.in/userfiles/company/16202938661299798774.png',
                imageWidth: 400,
                imageHeight: 200,
                imageAlt: 'Custom image',
        ...
        if(!passworPatten.test(cpass)){
            Swal.fire({
                title: 'Please Enter Valid Confirmed Passworrd !',
                text: 'Minimum eight and maximum 20 characters, at least one uppercase letter, one lowercase letter, one number and one special character: !!',
                imageUrl: 'https://ci3.googleusercontent.com/proxy/eR2Wo8Rz--CKyxFOPCz0Jq3g-IxKwTSD3G9GJxyNO_2KkmBWqxDKfB8n8vfhhcB3AX0AUHmwGu3YjJy_PVL39aGY2_3l-0-OnUz5V6UA=s0-d-e1-ft#http://eyevam.in/userfiles/company/16202938661299798774.png',
                imageWidth: 400,
                imageHeight: 200,
        ...
        if(pass != cpass){
            Swal.fire({
                title: 'Message!',
                text: 'Your Password and Confirmed Passworrd are not match',
                imageUrl: 'https://ci3.googleusercontent.com/proxy/eR2Wo8Rz--CKyxFOPCz0Jq3g-IxKwTSD3G9GJxyNO_2KkmBWqxDKfB8n8vfhhcB3AX0AUHmwGu3YjJy_PVL39aGY2_3l-0-OnUz5V6UA=s0-d-e1-ft#http://eyevam.in/userfiles/company/16202938661299798774.png',
                imageWidth: 400,
                imageHeight: 200,
                imageAlt: 'Custom image',
    ...
    $('#registrationForm').submit(function(e){
        ...
        e.preventDefault();
        if(!vendor_register_validate()) return;
