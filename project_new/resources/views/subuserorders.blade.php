                        ...
                        <div class="row" id="main">
                            <div id="my-orders-tab">
                                <ul class="nav nav-tabs tabs-left" role="tablist">
                                    <li role="presentation" class="active"><a href="#childuserorder" aria-controls="order" role="tab" data-toggle="tab">USER ORDER</a></li>
                                </ul>
                                <div class="order-table-responsive" id="childuserorder">
                                    <table class="table" id="childUserOrders">
...
<script>
    ...
    $("#childUserOrders").DataTable({
        ...
        'colReorder': true,
        'ajax': {
            'url': "{{url('/user/orders/get_active_childuserorder_details')}}",
            'method' : 'POST',
            'data': {
              "_token": "{{ csrf_token() }}"
            },
