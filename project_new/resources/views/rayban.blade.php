...
.dropdown-check-list.visible .items {
  display: block;
    ...
    <section style="background: url({{url('/assets')}}/images/categories/{{$category->feature_image}}) no-repeat center center; background-size: cover; border-radius : 20px; height:400px; width:100%">
    <!--<section>-->
     ...
     <!<div class="container-fluid">
             ...
             <div class="row margin-left-0 margin-right-0" style="">
                  <img src="https://india.ray-ban.com/pub/media/wysiwyg/Rb_home_opti/Sunglasses_Desktop_Banner_-_930x945.jpg" alt="Los Angeles" style="width:45%; height: 420px;  margin-top: 20px; margin-left: 45px;">
                  <img src="https://india.ray-ban.com/pub/media/wysiwyg/Rb_home_opti/Eyeglasses_Desktop_Banner_-_930x945.jpg" alt="Los Angeles"  style="width:45%; height: 420px; float: right; margin-right: 45px; margin-top: 20px;">
             </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                              ...
                                                              <div class="dropdown-check-list filter-product visible" tabindex="100" data-filter="color">
                                                                <span class="anchor"><b>Select Color</b></span>
                                                                <ul class="items">
                                                                <li>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                              ...
                                                              <div class="dropdown-check-list filter-product visible" tabindex="100" data-filter="shape">
                                                                <span class="anchor"><b>Select Shape</b></span>
                                                                <ul class="items">
                                                                <li>
                                                    ...
                                                    <div class="row">   
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                              ...
                                                              <div class="dropdown-check-list filter-product visible" tabindex="100" data-filter="shape">
                                                                <span class="anchor"><b>Select MakeStyle</b></span>
                                                                <ul class="items">
                                                                <li>
