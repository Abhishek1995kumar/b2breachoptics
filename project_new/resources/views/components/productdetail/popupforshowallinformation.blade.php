                            ...
                            <table width="100" class="table" style="table-layout: fixed;" border='0'>
                                <tbody>
                                    ...
                                    <tr style="border:none;">
                                        ...
                                        <td style="width: 5%; text-align: center;border:none;"> : </td>
                                        <td style="width: 54%;border:none;" class="frameColor">@if($productdata->framecolor =='') NA @else  {{$productdata->framecolor}}@endif</td>
                                    </tr>
                                    <tr style="border:none;">
                                    ...
                                    <tr style="border:none;">
                                        ...
                                        <td style="width: 5%; text-align: center;border:none;"> : </td>
                                        <td style="width: 54%;border:none;" class="productsku_info">@if($productdata->productsku =='') NA @else  {{$productdata->productsku}}@endif</td>
                                    </tr>
                                    <tr style="border:none;">
                            ...
                            <table width="100" class="table" border='0'> 
                                <tbody>
                                    ...
                                    <tr style="border:none;">
                                        ...
                                        <td style="width: 5%; text-align: center;border:none;"> : </td>
                                        <td style="width: 54%;border:none;" class="frameDimension">@if($productdata->productdimension=='') NA @else  {{$productdata->productdimension}}@endif</td>
                                    </tr>
                                    <tr style="border:none;">
                                ...
                                <tbody>
                                    ...
                                    @if($productdata->visioneffect != 'Single Vision')
                                        <tr style="border:none;">
                                            ...
                                            <td style="width: 5%; text-align: center;border:none;"> : </td>
                                            <td style="width: 54%;border:none;word-wrap: break-word;">@if($productdata->addpowerlens  =='') NA @else  {{str_replace(',',', ', $productdata->addpowerlens)}}@endif</td>
                                        </tr>
                                    @endif
                                    <tr style="border:none;">
                                        <td style="width: 40%; border:none;">Lens Color</td>
                                        <td style="width: 5%; text-align: center;border:none;"> : </td>
                                        <td style="width: 54%;border:none;" class="lensColor">@if($productdata->color=='') NA @else {{$productdata->color}}@endif</td>
                                    </tr>
                                    <tr style="border:none;">
                                    ...
                                    <tr style="border:none;">
                                        ...
                                        <td style="width: 5%; text-align: center;border:none;"> : </td>
                                        <td style="width: 54%;border:none;">@if($productdata->coating=='') NA @else {{str_replace(',',', ', $productdata->coating)}}@endif</td>
                                    </tr>
                                    <tr style="border:none;">
                                    ...
                                    @if($productdata->category[0] == 58)
                                        <tr style="border:none;">
                                            ...
                                            <td style="width: 5%; text-align: center;border:none;"> : </td>
                                            <td style="width: 54%;border:none;">@if($productdata->diameterlens =='') NA @else  {{str_replace(',',', ', $productdata->diameterlens)}}@endif</td>
                                        </tr>
                                        <tr style="border:none;">
                                            <td style="width: 40%; border:none;">Sphere</td>
                                            <td style="width: 5%; text-align: center;border:none;"> : </td>
                                            <td style="width: 54%;border:none;word-wrap: break-word;" >@if($productdata->sphere  =='') NA @else  {{str_replace(',',', ', $productdata->sphere)}}@endif</td>
                                        </tr>
                                    @endif
                                </tbody>
                            </table>
                            ...
                            <table width="100" class="table" style="table-layout: fixed;"  border='0'>
                                ...
                                @if($productdata->category[0] == 58)
                                    <tr style="border:none;">
                                        ...
                                        <td style="width: 5%; text-align: center;border:none;"> : </td>
                                        <td style="width: 54%;border:none;word-wrap: break-word;">@if($productdata->axisnlens  =='') NA @else  {{str_replace(',',', ', $productdata->axisnlens)}}@endif</td>
                                    </tr>
                                    <tr style="border:none;">
                                        <td style="width: 40%; border:none;">Cylinder</td>
                                        <td style="width: 5%; text-align: center;border:none;"> : </td>
                                        <td style="width: 54%;border:none;word-wrap: break-word;">@if($productdata->cylinderlens  =='') NA @else  {{str_replace(',',', ', $productdata->cylinderlens)}}@endif</td>
                                    </tr>
                                @else
                                    <tr style="border:none;">
                                        <td style="width: 40%; border:none;">Add Power</td>
                                        <td style="width: 5%; text-align: center;border:none;"> : </td>
                                        <td style="width: 54%;border:none;word-wrap: break-word;">@if($productdata->addpower =='') NA @else  {{str_replace(',',', ', $productdata->addpower)}}@endif</td>
                                    </tr>
                                @endif
                                </tbody>
                            </table>
                            ...
                            <table width="100" class="table" border='0' style="table-layout: fixed;">
                                <tbody>
                                    ...
                                    <tr style="border:none;">
                                        ...
                                        <td style="width: 5%; text-align: center;border:none;"> : </td>
                                        <td style="width: 54%;border:none;">@if($productdata->diameter =='') NA @else  {{str_replace(',',', ', $productdata->diameter)}}@endif</td>
                                    </tr>
                                    @if($productdata->powermin != '')
                                        <tr style="border:none;">
                                            ...
                                            <td style="width: 35%;border:none; word-wrap: break-word; overflow-wrap: break-word;">{{str_replace(',',', ', $productdata->powermin)}}</td>
                                        </tr>
                                    @endif
                                    @if($productdata->powermax!='')
                                        <tr style="border:none;">
                                            ...
                                            <td style="width: 3%; text-align: center;border:none;"> : </td>
                                            <td style="width: 35%; border:none; word-wrap: break-word; overflow-wrap: break-word;">{{str_replace(',',', ', $productdata->powermax)}}</td>
                                        </tr>
                                    @endif
                                        <tr style="border:none;">
                                    ...
                                    @if($productdata->cylindernew !='')
                                        <tr style="border:none;">
                                            <td style="width: 40%; border:none;">Cylinder</td>
                                            <td style="width: 3%; text-align: center;border:none;"> : </td>
                                            <td style="width: 54%;border:none; word-wrap: break-word; overflow-wrap: break-word;">{{str_replace(',',', ', $productdata->cylindernew)}}</td>
                                        </tr>
                                    @endif
                                    ...
                                    @if($productdata->axisnew !='')
                                        <tr style="border:none;">
                                            <td style="width: 40%; border:none;">Axis</td>
                                            <td style="width: 3%; text-align: center;border:none;"> : </td>
                                            <td style="width: 54%;border:none; word-wrap: break-word; overflow-wrap: break-word;">{{str_replace(',',', ', $productdata->axisnew)}}</td>
                                        </tr>
                                    @endif
                                    ...
                                    @if($productdata->addpower !='')
                                        <tr style="border:none;">
                                            <td style="width: 40%; border:none;">Add Power</td>
                                            <td style="width: 5%; text-align: center;border:none;"> : </td>
                                            <td style="width: 54%;border:none;">{{str_replace(',',', ', $productdata->addpower)}}</td>
                                        </tr>
                                    @endif
                                </tbody>
                            </table>
                            ...
                            <table width="100" class="table" border='0' style="table-layout: fixed;">
                                <tbody>
                                    <tr style="border:none;">
                                        ...
                                        <td style="width: 5%; text-align: center;border:none;"> : </td>
                                        <td style="width: 54%;border:none;">@if($productdata->basecurve =='') NA @else {{str_replace(',',', ', $productdata->basecurve)}}@endif</td>
                                    </tr>
                                    <tr style="border:none;">
                                    ...
                                    <tr style="border:none;">
                                        ...
                                        <td style="width: 5%; text-align: center;border:none;"> : </td>
                                        <td style="width: 54%;border:none;" class="contactLensColor">@if($productdata->lenscolor =='') NA @else {{$productdata->lenscolor}}@endif</td>
                                    </tr>
                                    <tr style="border:none;">
                            ...
                            <table width="100" class="table" border='0' style="table-layout: fixed;">
                                <tbody>
                                    ...
                                    <tr style="border:none;">
                                        ...
                                        <td style="width: 5%; text-align: center;border:none;"> : </td>
                                        <td style="width: 54%;border:none;" class="productColor">@if($productdata->productcolor =='') NA @else  {{$productdata->productcolor}}@endif</td>
                                    </tr>
                                    <tr style="border:none;">
                                        <td style="width: 40%; border:none;">Weight</td>
                                        <td style="width: 5%; text-align: center;border:none;"> : </td>
