                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="input-group">
                                    <input type="text" id="shape-input" name="name" placeholder="Shape Name" class="form-control" required value="{{$shape->name}}"/>
                                </div>
                            </div>
                        </div>
...
<script>
    $("#shape_edit").on("submit", function(e) {
        e.preventDefault();
        let url = "{{ route('admin.shape.edit', $shape->id) }}"; // Update with the correct route
        // console.log(url);
