                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            <ul class="nav nav-tabs tabs-left">
                                <?php
                                    if(in_array('LOGO', explode(',', session()->get('role')['general_settings']))) {
                                ?>
                                    <li class="active"><a href="#logo" data-toggle="tab" aria-expanded="true">Logo</a>
                                <?php } ?>
                                
                                <?php
                                    if(in_array('FAVICON', explode(',', session()->get('role')['general_settings']))) {
                                ?>
                                    <li class=""><a href="#favicon" data-toggle="tab" aria-expanded="true">Favicon</a>
                                <?php } ?>
                                
                                <?php
                                    if(in_array('WCGENERAL', explode(',', session()->get('role')['general_settings']))) {
                                ?>
                                    <li class=""><a href="#website" data-toggle="tab" aria-expanded="false">Website Contents</a>
                                <?php } ?>
                                
                                <?php
                                    if(in_array('PSGENERAL', explode(',', session()->get('role')['general_settings']))) {
                                ?>
                                    <li class=""><a href="#payment" data-toggle="tab" aria-expanded="false">Payment Settings</a></li>
                                <?php } ?>
                                
                                <?php
                                    if(in_array('PLGENERAL', explode(',', session()->get('role')['general_settings']))) {
                                ?>
                                ...
                                <?php
                                    if(in_array('SIGENERAL', explode(',', session()->get('role')['general_settings']))) {
                                ?>
                                    <li class=""><a href="#background" data-toggle="tab" aria-expanded="false">Subscription Image</a>
                                    </li>
                                <?php } ?>
                                
                                <?php
                                    if(in_array('AUGENERAL', explode(',', session()->get('role')['general_settings']))) {
                                ?>
                                ...
                                <?php
                                    if(in_array('OFFAGENERAL', explode(',', session()->get('role')['general_settings']))) {
                                ?>
                                ...
                                <?php
                                    if(in_array('FOOTER', explode(',', session()->get('role')['general_settings']))) {
                                ?>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="background">
                                    <p class="lead">Subscription Image</p>
                                    <div class="ln_solid"></div>
                                    <form method="POST" action="settings/background" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Current Subscription Image
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <!-- <input type="hidden" name="id" value="1"> -->
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Setup New Subscription Image <span class="required">*</span>
                                            <p class="small-label">(Preferred Size : 400px * 400px)</p>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
