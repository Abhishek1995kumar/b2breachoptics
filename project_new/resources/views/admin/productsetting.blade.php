                        ...
                        <div class="col-md-12">
                            <ul class="nav nav-tabs tabs-left">
                                ...
                                <?php
                                    if(in_array('CC',explode(',',session()->get('role')['manage_category']))){
                                ?>
                                    <li><a href="#lens_coating" data-toggle="tab" aria-expanded="true"><strong>Lens Coating</strong></a>
                                <?php
                                    }
                                ?>
                                ...
                                <?php
                                    if(in_array('CC',explode(',',session()->get('role')['manage_category']))){
                                ?>
                                    <li><a href="#lens_index" data-toggle="tab" aria-expanded="true"><strong>Lens Index</strong></a>
                                <?php
                                    }
                                ?>
                                ...
                                <?php
                                    if(in_array('CC',explode(',',session()->get('role')['manage_category']))){
                                ?>
                                    <li><a href="#lens_technology" data-toggle="tab" aria-expanded="true"><strong>Lens Technology</strong></a>
                                <?php
                                    }
                                ?>
                                ...
                                <?php
                                    if(in_array('CC',explode(',',session()->get('role')['manage_category']))){
                                ?>
                                    <li><a href="#packaging" data-toggle="tab" aria-expanded="true"><strong>contact product packaging</strong></a>
                                <?php
                                    }
                                ?>
                                ...
                                <?php
                                    if(in_array('CC',explode(',',session()->get('role')['manage_category']))){
                                ?> 
                                 <li><a href="#shape" data-toggle="tab" aria-expanded="true"><strong>Frame Shape</strong></a>
                                <?php       
                                    }
                                ?>
                                ...
                                <?php
                                    if(in_array('CC',explode(',',session()->get('role')['manage_category']))){
                                ?>
                                    <li><a href="#color" data-toggle="tab" aria-expanded="true"><strong>Frame Color</strong></a>
                                <?php
                                    }
                                ?>
                        ...
                        <div class="col-xs-12" style="padding: 0">
                            ...
                            <div class="tab-content">
                                            ...
                                            <table class="table table-striped table-bordered" cellspacing="0" id="example" width="100%">
                                                ...
                                                @foreach($brands as $category)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{(\App\Category::where('id', $category->category_id)->get()[0]->name)}}
                                                        </td>
                                                        <td style="display: flex; gap: 2px;">
                                                            ...
                                                            <a href="{{url('/admin/brand/editbrand')}}/{{$category->id}}" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Edit</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="display: flex; gap: 2px;">
                                                            ...
                                                            ?>
                                                                ...
                                                                <a href="{{url('/admin/material/editmaterial')}}/{{$sub->id}}"class="btn btn-primary btn-xs"><i class="fa fa-edit"></i>Edit</a>
                                                            <?php } ?>
                                                ...
                                                @foreach($lenscolors as $data)
                                                    <tr>
                                                        ...
                                                        <td style="display: flex; gap: 2px;">
                                                            ...
                                                            <a href="{{url('/admin/editlenscolor')}}/{{$data->id}}"class="btn btn-primary btn-xs"><i class="fa fa-edit"></i>Edit</a><br>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                ...
                                <?php
                                    if(in_array('V',session()->get('role')['role_actions']['cc'])){
                                ?>
                                    <div class="tab-pane" id="lens_coating">
                                        <div class="go-title">
                                        <div class="pull-right">
                                            <?php
                                                if(in_array('N', session()->get('role')['role_actions']['cc'])) {
                                            ?>
                                                <a href="{!! url('admin/lens_coating/create') !!}" class="btn btn-primary btn-add"><i class="fa fa-plus"></i> Add Lens Coating</a>
                                            <?php
                                                }
                                            ?>
                                        </div>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <table class="table table-striped table-bordered" cellspacing="0" id="example4" width="100%">
                                                ...
                                                <tbody>
                                                @foreach($lenscoatings as $data)
                                                    <tr>
                                                        <td>
                                                            {{$data->name}}
                                                        </td>
                                                        <td style="display: flex; gap: 2px;">
                                                            <a href="javascript:;" data-href="{{url('/')}}/admin/lens_coating/delete/{{$data->id}}" data-toggle="modal" data-target="#confirm-delete"class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Remove</a><br>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                ...
                                <?php
                                    if(in_array('V',session()->get('role')['role_actions']['cc'])){
                                ?>
                                    <div class="tab-pane" id="lens_index">
                                        <div class="go-title">
                                        <div class="pull-right">
                                            <?php
                                                if(in_array('N', session()->get('role')['role_actions']['cc'])) {
                                            ?>
                                                <a href="{!! url('admin/lens_index/create') !!}" class="btn btn-primary btn-add"><i class="fa fa-plus"></i> Add Lens Index</a>
                                            <?php
                                                }
                                            ?>
                                        </div>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <table class="table table-striped table-bordered" cellspacing="0" id="example5" width="100%">
                                                ...
                                                <tbody>
                                                @foreach($lensindex as $data)
                                                    <tr>
                                                        <td>
                                                            {{$data->name}}
                                                        </td>
                                                        <td style="display: flex; gap: 2px;">
                                                            <a href="javascript:;" data-href="{{url('/')}}/admin/lens_index/delete/{{$data->id}}" data-toggle="modal" data-target="#confirm-delete"class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Remove</a><br>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                ...
                                <?php
                                    if(in_array('V',session()->get('role')['role_actions']['cc'])){
                                ?>
                                    <div class="tab-pane" id="lens_technology">
                                        <div class="go-title">
                                        <div class="pull-right">
                                            <?php
                                                if(in_array('N', session()->get('role')['role_actions']['cc'])) {
                                            ?>
                                                <a href="{!! url('admin/lens_technology/create') !!}" class="btn btn-primary btn-add"><i class="fa fa-plus"></i> Add Lens Technology</a>
                                            <?php
                                                }
                                            ?>
                                        </div>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <table class="table table-striped table-bordered" cellspacing="0" id="example6" width="100%">
                                                ...
                                                <tbody>
                                                @foreach($lenstechnology as $data)
                                                    <tr>
                                                        <td>
                                                            {{$data->name}}
                                                        </td>
                                                        <td style="display: flex; gap: 2px;">
                                                            <a href="javascript:;" data-href="{{url('/')}}/admin/lens_technology/delete/{{$data->id}}" data-toggle="modal" data-target="#confirm-delete"class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Remove</a><br>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                                ...
                                                @foreach($contactcolors as $data)
                                                    <tr>
                                                        ...
                                                        <td style="display: flex; gap: 2px;">
                                                            ...
                                                            <a href="{{url('/admin/contactlens/editcontactlenscolor')}}/{{$data->id}}" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Edit</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                    ...
                                    <div class="tab-pane" id="packaging">
                                        ...
                                        <div class="pull-right">
                                            <?php
                                                if(in_array('N', session()->get('role')['role_actions']['cc'])) {
                                            ?>
                                                <a href="{!! url('admin/contactproductpackaging/create') !!}" class="btn btn-primary btn-add"><i class="fa fa-plus"></i> Add contactlens packaging</a>
                                            <?php
                                                }
                                            ?>
                                        </div>
                                        ...
                                        <div class="panel-body">
                                            <table class="table table-striped table-bordered" cellspacing="0" id="example7" width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <tbody>
                                                        @foreach($contactlens_packagig as $data)
                                                            <tr>
                                                                <td>
                                                                {{$data->name}}
                                                                </td>
                                                                <td>
                                                                <a href="javascript:;" data-href="{{url('/')}}/admin/contactlenspackaging/delete/{{$data->id}}" data-toggle="modal" data-target="#confirm-delete"class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Remove</a>
                                                                    <a href="{{url('/admin/contactproductpackaging/editcontactlenspackaging')}}/{{$data->id}}"class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Edit</a>
                                ...
                                ?>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <table class="table table-striped table-bordered" cellspacing="0" id="example8" width="100%">
                                                <thead>
                                                <tr>
                                                    <th>Shape Name</th>
                                                    <th>Actions</th>
                                                ...
                                                @foreach($shape as $data)
                                                    <tr>
                                                        ...
                                                        <td style="display: flex; gap: 2px;">
                                                            ...
                                                            <a href="{{url('/admin/shape/editshape')}}/{{$data->id}}"class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Edit</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                ...
                                ?>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <table class="table table-striped table-bordered" cellspacing="0" id="example9" width="100%">
                                                <thead>
                                                <tr>
                                                    <th>Color Name</th>
                                                    <th>Actions</th>
                                                ...
                                                @foreach($frame_color as $data)
                                                    <tr>
                                                        ...
                                                        <td style="display: flex; gap: 2px;">
                                                            ...
                                                            <a href="{{url('/admin/frame_color/editframe')}}/{{$data->id}}" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i>Edit</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                ...
                                ?>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <table class="table table-striped table-bordered" cellspacing="0" id="example10" width="100%">
                                                <thead>
                                                <tr>
                                                    <th>Material Name</th>
                                                    <th>Actions</th>
                                                ...
                                                @foreach($frame_material as $data)
                                                    <tr>
                                                        ...
                                                        <td style="display: flex; gap: 2px;">
                                                            ...
                                                            <a href="{{url('/admin/frame_material/editframematerial')}}/{{$data->id}}"class="btn btn-primary btn-xs"><i class="fa fa-edit"></i>Edit</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
