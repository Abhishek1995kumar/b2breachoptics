                                    ...
                                    <div  class="col-sm-6">
                                        <form action="{{route('role.updaterole')}}" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="role" id="rolemanage" value="{{$role[0]->role}}" aria-describedby="emailHelp" placeholder="Enter role">
