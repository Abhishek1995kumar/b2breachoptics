...
@section('content')
        ...
        <div class="row margin-left-0 margin-right-0" style="background-color:#c2af94; border-radius : 20px; background-image: linear-gradient(to right, #c2af94, #d8c3a5, #c2af94);">
            ...
            <div style="margin: 0% 0px 0% 0px;">
                <div class="text-center" style="color: #FFF;padding: 20px;">
                    <h1 style="color : black; margin-bottom : 0;"">{{$language->contact_us}}</h1>
                </div>
            </div>
    ...
    <div class="home-wrapper">
        ...
        <div class="section-padding contact-area-wrapper padding-bottom-0 padding-top-0 wow fadeInUp">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-7 col-sm-7">
                        <div class="contact-area-fullDiv">
                            <p id="contact_us_today">{{$language->contact_us_today}}</p>
                            <div class="comments-area">
                                <div class="comments-form">
                                    <form action="{{action('FrontEndController@contactmail')}}" method="POST">
                                        ...
                                        <p><textarea class="form-control" name="message" id="comment" placeholder="Write a Replay" cols="30" rows="10" required></textarea></p>
