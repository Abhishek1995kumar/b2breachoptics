...
<style>
    ...
    * {
    ...
    <div class="container-fluid">
        <section class="bannar-image" style="background: url({{url('/assets')}}/images/categories/{{$category->feature_image}}) no-repeat center center; background-size: auto; border-radius : 1.25rem; ">
            <!--<section>-->
                                                ...
                                                @if(isset($products[0]))
                                                  @if($products[0]->category[0] == 63)    
                                                    ...
                                                    <div class="row">   
                                                        <div class="col-lg-12">
                                                            <div class="form-group filter-section">
                                                                <span class="anchor"><b>Select Lens Material</b></span>
                                                    ...
                                                    <div class="row">   
                                                        <div class="col-lg-12">
                                                            <div class="form-group filter-section">
                                                                <span class="anchor"><b>Select Lens Technology</b></span>        
                                                    ...
                                                    <div class="row">   
                                                        <div class="col-lg-12">
                                                            <div class="form-group filter-section">
                                                              <span class="anchor"><b>Net Quantity</b></span>
                                                             <div class="dropdown-check-list filter-product " tabindex="100" data-filter='lenscolor'>
                                                              <ul class="items">
