    ...
    <div class="invoice_header">
        ...
        <tr>
            ...
            <td align="left" style="width: 50%;">
                ...
                <br>
                <div>Email: {{$array['email']}}</div>
                <div>Phone: {{$array['phone']}}</div>
            </td>
        </tr>
    </table>
    </div>
    ...
    <div class="padding_left_right">
        ...
        <tbody >
            <tr>
                ...
                <td style="padding: 10px;" colspan="2" class="text-right">{{$tax * $orders->quantity}}</td>
                <td style="padding: 10px;" colspan="2" class="text-right">{{$subtotal + ($tax * $orders->quantity)}}</td>
            </tr>
        </tbody>
        <tfoot>
            <!--<tr>-->
            ...
            <tr>
                ...
                <td colspan="4" style="padding: 10px; background-color : #f2f2f2; text-align: left;"><b>{{$subtotal + ($tax * $orders->quantity)}}</b></td>
            </tr>
        </tfoot>
        <tfoot>
            <tr>
            ...
            <footer style="text-align : center; color : #808080">
                Invoice was created by ELRICA GLOBAL ENTERPRISES PRIVATE LIMITED.
            </footer>
        </div>
